...
#define SCROLLING_SET_STARTERS                           0
#define SCROLLING_SET_STARTING_TOWNS                     1
#define SCROLLING_LILYCOVE_HARBOR_BEFORE_LEAGUE_OPTIONS  2
#define SCROLLING_SLATEPORT_HARBOR_BEFORE_LEAGUE_OPTIONS 3
#define SCROLLING_LILYCOVE_HARBOR_AFTER_LEAGUE_OPTIONS   4
#define SCROLLING_SLATEPORT_HARBOR_AFTER_LEAGUE_OPTIONS  5
#define SCROLLING_SET_FOSSILS                            6
#define SCROLLING_GAME_MODES                             7
#define SCROLLING_ENABLE_DISABLE_CANCEL                  8
