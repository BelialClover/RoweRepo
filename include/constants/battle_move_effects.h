...
#define EFFECT_MISC_HIT 360 //Multiple Effects
#define EFFECT_TOXIC_WASTE 361
#define EFFECT_GIGATON_HAMMER 362
#define EFFECT_INVERSE_ROOM 363
#define EFFECT_DRACO_METEOR 364
#define EFFECT_CHILLY_RECEPTION 365
#define EFFECT_SHED_TAIL 366

//Misc Hit Arguments
#define MISC_EFFECT_NONE                   0
#define MISC_EFFECT_TOOK_DAMAGE_BOOST      1 //Rage Fist
#define MISC_EFFECT_FAINTED_MON_BOOST      2 //Last Respect
#define MISC_EFFECT_ELECTRIC_TERRAIN_BOOST 3 //Psyblade
#define MISC_EFFECT_DOUBLE_DAMAGE          4 //
#define MISC_EFFECT_SEASONAL_TYPE          5 //
