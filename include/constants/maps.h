...
// pokemon locations.
#define MAP_GROUP_OVERWORLD_MONS MAP_GROUP(MAP_PETALBURG_CITY)
#define MAP_GROUP_SPECIAL_MONS_1 MAP_GROUP(MAP_METEOR_FALLS_1F_1R)
#define MAP_GROUP_SPECIAL_MONS_2 MAP_GROUP(MAP_SAFARI_ZONE_NORTHWEST)
