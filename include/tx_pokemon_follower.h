...
u16 getFollowerPaletteTag(void);
u16 getFollowerSpecies(void);
bool8 isFollowerShiny(void);
bool8 isPlayerPalette(u16 tag);
bool8 IsFollowerVisible(void);
...
void POF_TryToCreateFollower(void);
void POF_UpdateAlphaFollowerOffset(void);
