...
bool8 MapGridGetCollisionAt(int, int);
...
bool8 IsPosInIncomingConnectingMap(u8 direction, int x, int y, struct MapConnection *connection);
bool8 IsCoordInIncomingConnectingMap(int x, int src_width, int dest_width, int offset);
