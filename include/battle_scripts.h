...
extern const u8 BattleScript_WildAlphaBoostActivated[];
...
extern const u8 BattleScript_GuardDogBoost[];
...
extern const u8 BattleScript_EffectTricksterEnds[];
extern const u8 BattleScript_EffectOppositeDay[];
extern const u8 BattleScript_EffectOppositeDayEnds[];
...
extern const u8 BattleScript_EffectSeedSower[];
extern const u8 BattleScript_EffectWindPower[];
...
extern const u8 BattleScript_AttackerMoveRaisedAttack[];
extern const u8 BattleScript_AttackerMoveRaisedDefense[];
extern const u8 BattleScript_AttackerMoveRaisedSpecialAttack[];
extern const u8 BattleScript_AttackerMoveRaisedSpecialDefense[];
extern const u8 BattleScript_AttackerMoveRaisedSpeed[];
extern const u8 BattleScript_AttackerMoveLoweredStat[];
...
extern const u8 BattleScript_WildTotemBoostActivated2[];
extern const u8 BattleScript_WildTotemBoostActivated3[];
extern const u8 BattleScript_LegendaryPokemonBallBlock[];
extern const u8 BattleScript_AlphaPokemonBallBlock[];
extern const u8 BattleScript_CantCatchBallBlock[];
extern const u8 BattleScript_WildLegendaryMegaEvolution[];
extern const u8 BattleScript_WildAlphaMegaEvolution[];
...
extern const u8 BattleScript_BattlerAttackCursedSelf[];
extern const u8 BattleScript_BattlerAttackSeededOnHit[];
extern const u8 BattleScript_BattlerAttackChargedUser[];
extern const u8 BattleScript_BattlerAttackHealedUserStatus[];
extern const u8 BattleScript_BattlerAttackHealBlockOnHit[];
extern const u8 BattleScript_BattlerAttackHealedUser[];
extern const u8 BattleScript_BattlerAttackerStoleTargetStatChanges[];
extern const u8 BattleScript_BattlerAttackPerishSongOnHit[];
extern const u8 BattleScript_BattlerAttackInfestedOnHit[];
extern const u8 BattleScript_BattlerAttackRevertedTargetStatChanges[];
extern const u8 BattleScript_BattlerAttackDisabledTarget[];
