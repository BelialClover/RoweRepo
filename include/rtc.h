...
void RtcSetYear(u16 year);
void RtcSetMonth(u16 month);
void RtcSetDay(u16 day);
u16 getCurrentDayEvent(void);

void RtcSetNewDate(u16 year, u8 month, u8 day);
u8 getDaysofMonth(u8 month, u32 year);
u16 RtcGetDayCountWithExtras(void);
