...
void BattleAI_SetupAIData(u8 defaultScoreMoves, bool8 simulateDamage);
...
u8 AI_CheckBadMove(u8 battlerAtk, u8 battlerDef, u16 move, s16 score);
s32 DoMoveDamageCalcBattleMenu(u16 move, u8 battlerAtk, u8 battlerDef, u8 moveType, u8 critRoll, u8 randomFactor);
