...
struct BattleStruct
{
    ...
    u16 minDamage[MAX_BATTLERS_COUNT][MAX_BATTLERS_COUNT][MAX_MON_MOVES]; // AI, target, moves to make debugging easier
    u16 maxDamage[MAX_BATTLERS_COUNT][MAX_BATTLERS_COUNT][MAX_MON_MOVES]; // AI, target, moves to make debugging easier
...
#define IS_MOVE_PHYSICAL(move) (GetBattleMoveSplit(move) == SPLIT_PHYSICAL) //Unused
#define IS_MOVE_SPECIAL(move)  (GetBattleMoveSplit(move) == SPLIT_SPECIAL)  //Unused
#define IS_MOVE_STATUS(move)   (GetBattleMoveSplit(move) == SPLIT_STATUS)
...
#define IS_BATTLER_MOVE_STATUS(move, battlerId)   (GetBattleMoveSplitFromBattler(move, battlerId) == SPLIT_STATUS)
