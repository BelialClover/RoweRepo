...
void LoadFollowerPaletteDayNight(const void *src, u16 offset, u16 size);
...
void DoLoadFollowerSpritePaletteDayNight(const u16 *src, u16 paletteOffset);
...
bool8 isCurrentlyFullMoon(void);
