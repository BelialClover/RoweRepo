...
void SetFollowerPalette(const u16 *src, u16 *dest, u16 count, u16 rTone, u16 gTone, u16 bTone, bool8 excludeZeroes);
...
void SetFrontTrainerPalette(u8 paletteNum, u16 trainerPic, u8 costume, u8 gender, u8 redColor, u8 greenColor, u8 blueColor);
