...
extern const u8 Common_EventScript_SaveGame[];
extern const u8 Common_EventScript_Autosave[];
extern const u8 Common_EventScript_Refresh_Map[];
extern const u8 Common_EventScript_PkmnCenterJack[];
...
extern const u8 Start_EventScript_Game_Modes[];
