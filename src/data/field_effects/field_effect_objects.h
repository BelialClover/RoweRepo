...
const struct SpritePalette gSpritePalette_GeneralFieldEffect1_Summer = {gFieldEffectObjectPalette1_Summer, FLDEFF_PAL_TAG_GENERAL_1};
const struct SpritePalette gSpritePalette_GeneralFieldEffect1_Autumn = {gFieldEffectObjectPalette1_Autumn, FLDEFF_PAL_TAG_GENERAL_1};
const struct SpritePalette gSpritePalette_GeneralFieldEffect1_Winter = {gFieldEffectObjectPalette1_Winter, FLDEFF_PAL_TAG_GENERAL_1};
