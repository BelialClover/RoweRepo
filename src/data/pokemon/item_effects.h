...
const u8 *const gItemEffectTable[ITEMS_COUNT] =
{
    ...
    [ITEM_DEEP_SEA_TOOTH]       = gItemEffect_EvoStone,
    [ITEM_DEEP_SEA_SCALE]       = gItemEffect_EvoStone,
    [ITEM_PRISM_SCALE]          = gItemEffect_EvoStone,
    [ITEM_METAL_COAT]           = gItemEffect_EvoStone,
    [ITEM_PROTECTOR]            = gItemEffect_EvoStone,
    [ITEM_DRAGON_SCALE]         = gItemEffect_EvoStone,
    [ITEM_ELECTIRIZER]          = gItemEffect_EvoStone,
    [ITEM_MAGMARIZER]           = gItemEffect_EvoStone,
    ...
    [ITEM_PEAT_BLOCK]           = gItemEffect_EvoStone,
    [ITEM_AUSPICIOUS_ARMOR]     = gItemEffect_EvoStone,
    [ITEM_MALICIOUS_ARMOR]      = gItemEffect_EvoStone,
    [ITEM_SWEET_APPLE]          = gItemEffect_EvoStone,
    [ITEM_TART_APPLE]           = gItemEffect_EvoStone,
    [ITEM_SYRUP_APPLE]          = gItemEffect_EvoStone,
    [ITEM_SCROLL_OF_DARKNESS]   = gItemEffect_EvoStone,
    [ITEM_SCROLL_OF_WATERS]     = gItemEffect_EvoStone,
    [ITEM_METAL_ALLOY]          = gItemEffect_EvoStone,
    [ITEM_BLACK_AUGURITE]       = gItemEffect_EvoStone,
    [ITEM_CHIPPED_POT]          = gItemEffect_EvoStone,
    [ITEM_CRACKED_POT]          = gItemEffect_EvoStone,
    [ITEM_GALARICA_CUFF]        = gItemEffect_EvoStone,
    [ITEM_GALARICA_TWIG]        = gItemEffect_EvoStone,
    [ITEM_RAINBOW_SWEET]        = gItemEffect_EvoStone,
