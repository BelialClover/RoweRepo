const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_GROWLITHE_HISUIAN] = sGrowlithe_HusianLevelUpLearnset,
    [SPECIES_ARCANINE_HISUIAN] = sArcanine_HusianLevelUpLearnset,
    [SPECIES_VOLTORB_HISUIAN] = sVoltorb_HusianLevelUpLearnset,
    [SPECIES_ELECTRODE_HISUIAN] = sElectrode_HusianLevelUpLearnset,
    [SPECIES_TYPHLOSION_HISUIAN] = sTyphlosion_HusianLevelUpLearnset,
	[SPECIES_QWILFISH_HISUIAN] = sQwilfishHusianLevelUpLearnset,
    [SPECIES_SNEASEL_HISUIAN] = sSneasel_HusianLevelUpLearnset,
    [SPECIES_SAMUROTT_HISUIAN] = sSamurott_HusianLevelUpLearnset,
    [SPECIES_LILLIGANT_HISUIAN] = sLilligant_HusianLevelUpLearnset,
    [SPECIES_ZORUA_HISUIAN] = sZorua_HusianLevelUpLearnset,
    [SPECIES_ZOROARK_HISUIAN] = sZoroark_HusianLevelUpLearnset,
    [SPECIES_BRAVIARY_HISUIAN] = sBraviary_HusianLevelUpLearnset,
    [SPECIES_SLIGGOO_HISUIAN] = sSliggoo_HusianLevelUpLearnset,
    [SPECIES_GOODRA_HISUIAN] = sGoodra_HusianLevelUpLearnset,
    [SPECIES_AVALUGG_HISUIAN] = sAvalugg_HusianLevelUpLearnset,
    [SPECIES_DECIDUEYE_HISUIAN] = sDecidueye_HusianLevelUpLearnset,
    ...
    [SPECIES_ORICORIO_PA_U] = sOricorio_PauLevelUpLearnset,
    ...
    [SPECIES_URSALUNA_BLOODMOON]        = sUrsalunaLevelUpLearnset,
