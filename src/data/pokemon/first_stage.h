const struct Evolution gFirstEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM_NOT_SEVII, ITEM_THUNDER_STONE, SPECIES_RAICHU},
    ...
    [SPECIES_EXEGGCUTE]	            = {{EVO_ITEM_NOT_SEVII, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
    ...
    [SPECIES_MEOWTH_ALOLA]         = {{EVO_FRIENDSHIP, 28, SPECIES_PERSIAN_ALOLA}},
    [SPECIES_GEODUDE_ALOLA]        = {{EVO_LEVEL, 25, SPECIES_GRAVELER_ALOLA}},
    [SPECIES_GRAVELER_ALOLA]       = {{EVO_TRADE, 0, SPECIES_GOLEM_ALOLA}},
    ...
    [SPECIES_SLOWPOKE_GALAR]     = {{EVO_LEVEL, 37, SPECIES_SLOWBRO_GALAR},
                                       {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING_GALAR}},
    ...
    [SPECIES_DARUMAKA_GALAR]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALAR}},
    [SPECIES_YAMASK_GALAR]       = {{EVO_LEVEL, 34, SPECIES_RUNERIGUS}},
    ...
    [SPECIES_FLOETTE_YELLOW] = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES_YELLOW}},
    [SPECIES_FLOETTE_ORANGE] = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES_ORANGE}},
    [SPECIES_FLOETTE_BLUE]   = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES_BLUE}},
    [SPECIES_FLOETTE_WHITE]  = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES_WHITE}},
