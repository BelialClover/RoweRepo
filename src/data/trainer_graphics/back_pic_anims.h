...
static const union AnimCmd *const sBackAnims_Blue[] =
{
    sAnim_GeneralFrame0,
    gAnimCmd_Leaf_1,
};

static const union AnimCmd *const sBackAnims_Hilda[] =
{
    sAnim_GeneralFrame3,
    gAnimCmd_May_Steven_1,
};
...
const union AnimCmd *const *const gTrainerBackAnimsPtrTable[] =
{
    ...
    [TRAINER_BACK_PIC_HILDA]                 = sBackAnims_Hilda,
    [TRAINER_BACK_PIC_BLUE]                  = sBackAnims_Blue,
    [TRAINER_BACK_PIC_RED_RBY]               = sBackAnims_Red,
    [TRAINER_BACK_PIC_GOLD]                  = sBackAnims_Gold,
    [TRAINER_BACK_PIC_KRIS]                  = sBackAnims_Kris,
    [TRAINER_BACK_PIC_GREEN]                 = sBackAnims_Red,
    [TRAINER_BACK_PIC_ORAS_BRENDAN]          = sBackAnims_RubySapphireBrendan,
    [TRAINER_BACK_PIC_ORAS_MAY]              = sBackAnims_RubySapphireMay,
    [TRAINER_BACK_PIC_DAWN_PT]               = sBackAnims_Dawn,
};
