...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
	...
	[TRAINER_PIC_HILDA] = sAnims_RubySapphireMay,
	[TRAINER_PIC_BLUE] = sAnims_Leaf,
    [TRAINER_PIC_RED_RBY] = sAnims_Red,
	[TRAINER_PIC_PAINTER] = sAnims_RubySapphireMay,
	[TRAINER_PIC_ROCKET_GRUNT_M] = sAnims_RubySapphireMay,
	[TRAINER_PIC_ROCKET_GRUNT_F] = sAnims_RubySapphireMay,
	[TRAINER_PIC_SCIENTIST] = sAnims_RubySapphireMay,
	[TRAINER_PIC_JUGGLER] = sAnims_RubySapphireMay,
	[TRAINER_PIC_COOL_COUPLE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_TAMER] = sAnims_RubySapphireMay,
	[TRAINER_PIC_CRUSH_GIRL] = sAnims_RubySapphireMay,
	[TRAINER_PIC_POKEMON_BREEDER] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_BROCK] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_MISTY] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_LT_SURGE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_ERIKA] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_KOGA] = sAnims_RubySapphireMay,
    ...
    [TRAINER_PIC_ELITE_FOUR_LORELEI] = sAnims_RubySapphireMay,
    [TRAINER_PIC_ELITE_FOUR_BRUNO] = sAnims_RubySapphireMay,
    [TRAINER_PIC_ELITE_FOUR_AGATHA] = sAnims_RubySapphireMay,
    [TRAINER_PIC_ELITE_FOUR_LANCE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_CHAMPION_RIVAL] = sAnims_RubySapphireMay,
    ...
    [TRAINER_PIC_LEADER_ROARK]         = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_GARDENIA]      = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_MAYLENE]       = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_CRASHER_WAKE]  = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_FANTINA]       = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_BYRON]         = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_CANDICE]       = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_VOLKNER]       = sAnims_RubySapphireMay,
};
