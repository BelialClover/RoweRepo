const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(WOOPER_PALDEA, gMonPalette_Wooper_Paldea),
    ...
    SPECIES_PAL(RATTATA_ALOLA, gMonPalette_RattataAlola),
    SPECIES_PAL(RATICATE_ALOLA, gMonPalette_RaticateAlola),
    SPECIES_PAL(RAICHU_ALOLA, gMonPalette_RaichuAlola),
    SPECIES_PAL(SANDSHREW_ALOLA, gMonPalette_SandshrewAlola),
    SPECIES_PAL(SANDSLASH_ALOLA, gMonPalette_SandslashAlola),
    SPECIES_PAL(VULPIX_ALOLA, gMonPalette_VulpixAlola),
    SPECIES_PAL(NINETALES_ALOLA, gMonPalette_NinetalesAlola),
    SPECIES_PAL(DIGLETT_ALOLA, gMonPalette_DiglettAlola),
    SPECIES_PAL(DUGTRIO_ALOLA, gMonPalette_DugtrioAlola),
    SPECIES_PAL(MEOWTH_ALOLA, gMonPalette_MeowthAlola),
    SPECIES_PAL(PERSIAN_ALOLA, gMonPalette_PersianAlola),
    SPECIES_PAL(GEODUDE_ALOLA, gMonPalette_GeodudeAlola),
    SPECIES_PAL(GRAVELER_ALOLA, gMonPalette_GravelerAlola),
    SPECIES_PAL(GOLEM_ALOLA, gMonPalette_GolemAlola),
    SPECIES_PAL(GRIMER_ALOLA, gMonPalette_GrimerAlola),
    SPECIES_PAL(MUK_ALOLA, gMonPalette_MukAlola),
    SPECIES_PAL(EXEGGUTOR_ALOLA, gMonPalette_ExeggutorAlola),
    SPECIES_PAL(MAROWAK_ALOLA, gMonPalette_MarowakAlola),

    SPECIES_PAL(MEOWTH_GALAR, gMonPalette_MeowthGalar),
    SPECIES_PAL(PONYTA_GALAR, gMonPalette_PonytaGalar),
    SPECIES_PAL(RAPIDASH_GALAR, gMonPalette_RapidashGalar),
    SPECIES_PAL(SLOWPOKE_GALAR, gMonPalette_SlowpokeGalar),
    SPECIES_PAL(SLOWBRO_GALAR, gMonPalette_SlowbroGalar),
    SPECIES_PAL(FARFETCHD_GALAR, gMonPalette_FarfetchdGalar),
    SPECIES_PAL(WEEZING_GALAR, gMonPalette_WeezingGalar),
    SPECIES_PAL(MR_MIME_GALAR, gMonPalette_MrMimeGalar),
    SPECIES_PAL(ARTICUNO_GALAR, gMonPalette_ArticunoGalar),
    SPECIES_PAL(ZAPDOS_GALAR, gMonPalette_ZapdosGalar),
    SPECIES_PAL(MOLTRES_GALAR, gMonPalette_MoltresGalar),
    SPECIES_PAL(SLOWKING_GALAR, gMonPalette_SlowkingGalar),
    SPECIES_PAL(CORSOLA_GALAR, gMonPalette_CorsolaGalar),
    SPECIES_PAL(ZIGZAGOON_GALAR, gMonPalette_ZigzagoonGalar),
    SPECIES_PAL(LINOONE_GALAR, gMonPalette_LinooneGalar),
    SPECIES_PAL(DARUMAKA_GALAR, gMonPalette_DarumakaGalar),
    SPECIES_PAL(DARMANITAN_GALAR, gMonPalette_DarmanitanGalar),
    SPECIES_PAL(YAMASK_GALAR, gMonPalette_YamaskGalar),
    SPECIES_PAL(STUNFISK_GALAR, gMonPalette_StunfiskGalar),
    ...
    SPECIES_PAL(PIKACHU_PHD, gMonPalette_PikachuPhD),
    SPECIES_PAL(PIKACHU_LIBRE, gMonPalette_PikachuLibre),

    SPECIES_PAL(PIKACHU_ORIGINAL, gMonPalette_PikachuOriginalCap),
    SPECIES_PAL(PIKACHU_HOENN, gMonPalette_PikachuHoennCap),
    SPECIES_PAL(PIKACHU_SINNOH, gMonPalette_PikachuSinnohCap),
    SPECIES_PAL(PIKACHU_UNOVA, gMonPalette_PikachuUnovaCap),
    SPECIES_PAL(PIKACHU_KALOS, gMonPalette_PikachuKalosCap),
    SPECIES_PAL(PIKACHU_ALOLA, gMonPalette_PikachuAlolaCap),
    SPECIES_PAL(PIKACHU_PARTNER, gMonPalette_PikachuPartnerCap),
    SPECIES_PAL(PIKACHU_WORLD, gMonPalette_PikachuWorldCap),
    ...
    SPECIES_PAL(UNOWN_EXCLAMATION, gMonPalette_Unown),
    SPECIES_PAL(UNOWN_QUESTION, gMonPalette_Unown),
    ...
    SPECIES_PAL(BURMY_SANDY, gMonPalette_BurmySandyCloak),
    SPECIES_PAL(BURMY_TRASH, gMonPalette_BurmyTrashCloak),

    SPECIES_PAL(WORMADAM_SANDY, gMonPalette_WormadamSandyCloak),
    SPECIES_PAL(WORMADAM_TRASH, gMonPalette_WormadamTrashCloak),

    SPECIES_PAL(CHERRIM_SUNSHINE, gMonPalette_CherrimSunshine),

    SPECIES_PAL(SHELLOS_EAST, gMonPalette_ShellosEastSea),

    SPECIES_PAL(GASTRODON_EAST, gMonPalette_GastrodonEastSea),
    ...
    SPECIES_PAL(GENESECT_DOUSE, gMonPalette_GenesectDouseDrive),
    SPECIES_PAL(GENESECT_SHOCK, gMonPalette_GenesectShockDrive),
    SPECIES_PAL(GENESECT_BURN, gMonPalette_GenesectBurnDrive),
    SPECIES_PAL(GENESECT_CHILL, gMonPalette_GenesectChillDrive),
    ...
    SPECIES_PAL(VIVILLON_POKEBALL, gMonPalette_VivillonPokeBall),

    SPECIES_PAL(FLABEBE_YELLOW, gMonPalette_FlabebeYellowFlower),
    SPECIES_PAL(FLABEBE_ORANGE, gMonPalette_FlabebeOrangeFlower),
    SPECIES_PAL(FLABEBE_BLUE, gMonPalette_FlabebeBlueFlower),
    SPECIES_PAL(FLABEBE_WHITE, gMonPalette_FlabebeWhiteFlower),

    SPECIES_PAL(FLOETTE_YELLOW, gMonPalette_FloetteYellowFlower),
    SPECIES_PAL(FLOETTE_ORANGE, gMonPalette_FloetteOrangeFlower),
    SPECIES_PAL(FLOETTE_BLUE, gMonPalette_FloetteBlueFlower),
    SPECIES_PAL(FLOETTE_WHITE, gMonPalette_FloetteWhiteFlower),
    SPECIES_PAL(FLOETTE_ETERNAL, gMonPalette_FloetteEternalFlower),

    SPECIES_PAL(FLORGES_YELLOW, gMonPalette_FlorgesYellowFlower),
    SPECIES_PAL(FLORGES_ORANGE, gMonPalette_FlorgesOrangeFlower),
    SPECIES_PAL(FLORGES_BLUE, gMonPalette_FlorgesBlueFlower),
    SPECIES_PAL(FLORGES_WHITE, gMonPalette_FlorgesWhiteFlower),

    SPECIES_PAL(FURFROU_HEART, gMonPalette_FurfrouHeartTrim),
    SPECIES_PAL(FURFROU_STAR, gMonPalette_FurfrouStarTrim),
    SPECIES_PAL(FURFROU_DIAMOND, gMonPalette_FurfrouDiamondTrim),
    SPECIES_PAL(FURFROU_DEBUTANTE, gMonPalette_FurfrouDebutanteTrim),
    SPECIES_PAL(FURFROU_MATRON, gMonPalette_FurfrouMatronTrim),
    SPECIES_PAL(FURFROU_DANDY, gMonPalette_FurfrouDandyTrim),
    SPECIES_PAL(FURFROU_LA_REINE, gMonPalette_FurfrouLaReineTrim),
    SPECIES_PAL(FURFROU_KABUKI, gMonPalette_FurfrouKabukiTrim),
    SPECIES_PAL(FURFROU_PHARAOH, gMonPalette_FurfrouPharaohTrim),
    ...
    SPECIES_PAL(MINIOR_CORE, gMonPalette_MiniorCoreRed),

    SPECIES_PAL(MINIOR_METEOR_ORANGE, gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_METEOR_YELLOW, gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_METEOR_GREEN,  gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_METEOR_BLUE,   gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_METEOR_INDIGO, gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_METEOR_VIOLET, gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_ORANGE,   gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_YELLOW,   gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_GREEN,    gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_BLUE,     gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_INDIGO,   gMonPalette_CircledQuestionMark), //Unused
    SPECIES_PAL(MINIOR_CORE_VIOLET,   gMonPalette_CircledQuestionMark), //Unused
    ...
    SPECIES_PAL(MAGEARNA_ORIGINAL, gMonPalette_MagearnaOriginalColor),
    ...
    SPECIES_PAL(EISCUE_NOICE, gMonPalette_EiscueNoiceFace),

    SPECIES_PAL(INDEEDEE_F, gMonPalette_IndeedeeF),

    SPECIES_PAL(MORPEKO_HANGRY, gMonPalette_MorpekoHangry),

    SPECIES_PAL(ZACIAN_CROWNED, gMonPalette_ZacianCrownedSword),

    SPECIES_PAL(ZAMAZENTA_CROWNED, gMonPalette_ZamazentaCrownedShield),

    SPECIES_PAL(ETERNATUS_ETERNAMAX, gMonPalette_Eternatus/*Eternamax*/),

    SPECIES_PAL(URSHIFU_RAPID_STRIKE, gMonPalette_UrshifuRapidStrikeStyle),

    SPECIES_PAL(ZARUDE_DADA, gMonPalette_ZarudeDada),

    SPECIES_PAL(CALYREX_ICE, gMonPalette_CalyrexIceRider),
    SPECIES_PAL(CALYREX_SHADOW, gMonPalette_CalyrexShadowRider),
    ...
    SPECIES_PAL(OINKOLOGNE_F, gMonPalette_Oinkologne_F),
    ...
    SPECIES_PAL(GOUGING_FIRE, gMonPalette_Ogerpon),
    SPECIES_PAL(RAGING_BOLT, gMonPalette_Ogerpon),
    SPECIES_PAL(IRON_BOULDER, gMonPalette_Ogerpon),
    SPECIES_PAL(IRON_CROWN, gMonPalette_Ogerpon),
    SPECIES_PAL(TERAPAGOS, gMonPalette_Ogerpon),
    SPECIES_PAL(PECHARUNT, gMonPalette_Ogerpon),
    SPECIES_PAL(ZERAORA_MEGA, gMonPalette_Zeraora_Mega),
    SPECIES_PAL(VENUSAUR_MEGA_G, gMonPalette_Venusaur_Mega_G),
    SPECIES_PAL(URSHIFU_MEGA_SINGLE_STRIKE, gMonPalette_Urshifu_Mega_Single_Strike),
    SPECIES_PAL(URSHIFU_MEGA_RAPID_STRIKE, gMonPalette_Urshifu_Mega_Rapid_Strike),
    SPECIES_PAL(TOXTRICITY_MEGA_LOW_KEY, gMonPalette_Toxtricity_Mega_Low_Key),
    SPECIES_PAL(TOXTRICITY_MEGA, gMonPalette_Toxtricity_Mega),
    SPECIES_PAL(TATSUGIRI_MEGA_STRETCHY, gMonPalette_Tatsugiri_Mega_Stretchy),
    SPECIES_PAL(TATSUGIRI_MEGA_CURLY, gMonPalette_Tatsugiri_Mega_Curly),
    SPECIES_PAL(TATSUGIRI_MEGA_DROOPY, gMonPalette_Tatsugiri_Mega_Droopy),
    SPECIES_PAL(STARAPTOR_MEGA, gMonPalette_Staraptor_Mega),
    SPECIES_PAL(SCOVILLAIN_MEGA, gMonPalette_Scovillain_Mega),
    SPECIES_PAL(SANDSLASH_MEGA_ALOLA, gMonPalette_Sandslash_Mega_Alolan),
    SPECIES_PAL(RILLABOOM_MEGA, gMonPalette_Rillaboom_Mega),
    SPECIES_PAL(CINDERACE_MEGA, gMonPalette_Cinderace_Mega),
    SPECIES_PAL(MEOWSTIC_MEGA_F, gMonPalette_Meowstic_Mega_Female),
    SPECIES_PAL(MEOWSTIC_MEGA, gMonPalette_Meowstic_Mega),
    SPECIES_PAL(MELMETAL_MEGA, gMonPalette_Melmetal_Mega),
    SPECIES_PAL(MAGEARNA_MEGA, gMonPalette_Magearna_Mega),
    SPECIES_PAL(LUCARIO_MEGA_Z, gMonPalette_Lucario_Mega_Z),
    SPECIES_PAL(INTELEON_MEGA, gMonPalette_Inteleon_Mega),
    SPECIES_PAL(HEATRAN_MEGA, gMonPalette_Heatran_Mega),
    SPECIES_PAL(GRIMMSNARL_MEGA, gMonPalette_Grimmsnarl_Mega),
    SPECIES_PAL(GOLURK_MEGA, gMonPalette_Golurk_Mega),
    SPECIES_PAL(GOLISOPOD_MEGA, gMonPalette_Golisopod_Mega),
    SPECIES_PAL(GARCHOMP_MEGA_Z, gMonPalette_Garchomp_Mega_Z),
    SPECIES_PAL(GLIMMORA_MEGA, gMonPalette_Glimmora_Mega),
    SPECIES_PAL(DARKRAI_MEGA, gMonPalette_Darkrai_Mega),
    SPECIES_PAL(CRABOMINABLE_MEGA, gMonPalette_Crabominable_Mega),
    SPECIES_PAL(CHIMECHO_MEGA, gMonPalette_Chimecho_Mega),
    SPECIES_PAL(BLASTOISE_MEGA_G, gMonPalette_Blastoise_Mega_G),
    SPECIES_PAL(BAXCALIBUR_MEGA, gMonPalette_Baxcalibur_Mega),
    SPECIES_PAL(ARBOK_MEGA, gMonPalette_Arbok_Mega),
    SPECIES_PAL(ABSOL_MEGA_Z, gMonPalette_Absol_Mega_Z),
    SPECIES_PAL(VANILLUXE_MEGA, gMonPalette_Vanilluxe_Mega),
    SPECIES_PAL(TYPHLOSION_HISUI_MEGA, gMonPalette_Typhlosion_Hisui_Mega),
    SPECIES_PAL(TYPHLOSION_MEGA, gMonPalette_Typhlosion_Mega),
    SPECIES_PAL(TSAREENA_MEGA, gMonPalette_Tsareena_Mega),
    SPECIES_PAL(TOUCANNON_MEGA, gMonPalette_Toucannon_Mega),
    SPECIES_PAL(STARMIE_MEGA_REDUX, gMonPalette_Starmie_Mega_Redux),
    SPECIES_PAL(CLEFABLE_MEGA_REDUX, gMonPalette_Clefable_Mega_Redux),
    SPECIES_PAL(TINKATON_MEGA, gMonPalette_Tinkaton_Mega),
    SPECIES_PAL(SLOWKING_GALAR_MEGA, gMonPalette_Slowking_Galar_Mega),
    SPECIES_PAL(SLOWKING_MEGA, gMonPalette_Slowking_Mega),
    SPECIES_PAL(SLOWBRO_GALAR_MEGA, gMonPalette_Slowbro_Galar_Mega),
    SPECIES_PAL(SHUCKLE_MEGA, gMonPalette_Shuckle_Mega),
    SPECIES_PAL(SHEDINJA_MEGA, gMonPalette_Shedinja_Mega),
    SPECIES_PAL(SERPERIOR_MEGA, gMonPalette_Serperior_Mega),
    SPECIES_PAL(SANDSLASH_MEGA, gMonPalette_Sandslash_Mega),
    SPECIES_PAL(SAMUROTT_HISUI_MEGA, gMonPalette_Samurott_Hisui_Mega),
    SPECIES_PAL(SAMUROTT_MEGA, gMonPalette_Samurott_Mega),
    SPECIES_PAL(RIBOMBEE_MEGA, gMonPalette_Ribombee_Mega),
    SPECIES_PAL(QUAGSIRE_MEGA, gMonPalette_Quagsire_Mega),
    SPECIES_PAL(MILOTIC_MEGA, gMonPalette_Milotic_Mega),
    SPECIES_PAL(LUXRAY_MEGA, gMonPalette_Luxray_Mega),
    SPECIES_PAL(LANTURN_MEGA, gMonPalette_Lanturn_Mega),
    SPECIES_PAL(KROOKODILE_MEGA, gMonPalette_Krookodile_Mega),
    SPECIES_PAL(FLYGON_MEGA, gMonPalette_Flygon_Mega),
    SPECIES_PAL(DEWGONG_MEGA, gMonPalette_Dewgong_Mega),
    SPECIES_PAL(CROBAT_MEGA, gMonPalette_Crobat_Mega),
    SPECIES_PAL(CLODSIRE_MEGA, gMonPalette_Clodsire_Mega),
    SPECIES_PAL(BRELOOM_MEGA, gMonPalette_Breloom_Mega),
    SPECIES_PAL(RAICHU_MEGA_Y, gMonPalette_Raichu_Mega_Y),
    SPECIES_PAL(RAICHU_MEGA_X, gMonPalette_Raichu_Mega_X),
    SPECIES_PAL(FLOETTE_MEGA, gMonPalette_Floette_Mega),
    SPECIES_PAL(FALINKS_MEGA, gMonPalette_Falinks_Mega),
    SPECIES_PAL(DRAMPA_MEGA, gMonPalette_Drampa_Mega),
    SPECIES_PAL(ZYGARDE_MEGA, gMonPalette_Zygarde_Mega),
    SPECIES_PAL(HAWLUCHA_MEGA, gMonPalette_Hawlucha_Mega),
    SPECIES_PAL(DRAGALGE_MEGA, gMonPalette_Dragalge_Mega),
    SPECIES_PAL(BARBARACLE_MEGA, gMonPalette_Barbaracle_Mega),
    SPECIES_PAL(MALAMAR_MEGA, gMonPalette_Malamar_Mega),
    SPECIES_PAL(PYROAR_MEGA, gMonPalette_Pyroar_Mega),
    SPECIES_PAL(GRENINJA_MEGA, gMonPalette_Greninja_Mega),
    SPECIES_PAL(CHESNAUGHT_MEGA, gMonPalette_Chesnaught_Mega),
    SPECIES_PAL(DELPHOX_MEGA, gMonPalette_Delphox_Mega),
    SPECIES_PAL(CHANDELURE_MEGA, gMonPalette_Chandelure_Mega),
    SPECIES_PAL(EELEKTROSS_MEGA, gMonPalette_Eelektross_Mega),
    SPECIES_PAL(SCRAFTY_MEGA, gMonPalette_Scrafty_Mega),
    SPECIES_PAL(SCOLIPEDE_MEGA, gMonPalette_Scolipede_Mega),
    SPECIES_PAL(EXCADRILL_MEGA, gMonPalette_Excadrill_Mega),
    SPECIES_PAL(EMBOAR_MEGA, gMonPalette_Emboar_Mega),
    SPECIES_PAL(FROSLASS_MEGA, gMonPalette_Froslass_Mega),
    SPECIES_PAL(SKARMORY_MEGA, gMonPalette_Skarmory_Mega),
    SPECIES_PAL(FERALIGATR_MEGA, gMonPalette_Feraligatr_Mega),
    SPECIES_PAL(MEGANIUM_MEGA, gMonPalette_Meganium_Mega),
    SPECIES_PAL(STARMIE_MEGA, gMonPalette_Starmie_Mega),
    SPECIES_PAL(DRAGONITE_MEGA, gMonPalette_Dragonite_Mega),
    SPECIES_PAL(VICTREEBEL_MEGA, gMonPalette_Victreebel_Mega),
    SPECIES_PAL(CLEFABLE_MEGA, gMonPalette_Clefable_Mega),
    SPECIES_PAL(SNORLAX_MEGA, gMonPalette_Snorlax_Mega),
    SPECIES_PAL(SANDACONDA_MEGA, gMonPalette_Sandaconda_Mega),
    SPECIES_PAL(ORBEETLE_MEGA, gMonPalette_Orbeetle_Mega),
    SPECIES_PAL(MACHAMP_MEGA, gMonPalette_Machamp_Mega),
    SPECIES_PAL(LAPRAS_MEGA, gMonPalette_Lapras_Mega),
    SPECIES_PAL(KINGLER_MEGA, gMonPalette_Kingler_Mega),
    SPECIES_PAL(HATTERENE_MEGA, gMonPalette_Hatterene_Mega),
    SPECIES_PAL(GARBODOR_MEGA, gMonPalette_Garbodor_Mega),
    SPECIES_PAL(FLAPPLE_MEGA, gMonPalette_Flapple_Mega),
    SPECIES_PAL(DREDNAW_MEGA, gMonPalette_Drednaw_Mega),
    SPECIES_PAL(CORVIKNIGHT_MEGA, gMonPalette_Corviknight_Mega),
    SPECIES_PAL(COALOSSAL_MEGA, gMonPalette_Coalossal_Mega),
    SPECIES_PAL(CENTISKORCH_MEGA, gMonPalette_Centiskorch_Mega),
    SPECIES_PAL(BUTTERFREE_MEGA, gMonPalette_Butterfree_Mega),
    SPECIES_PAL(APPLETUN_MEGA, gMonPalette_Appletun_Mega),
    SPECIES_PAL(ALCREMIE_MEGA, gMonPalette_Alcremie_Mega),
    ...
    SPECIES_PAL(OGERPON_HEARTHFLAME, gMonPalette_Ogerpon_Hearthflame_Mask),
    SPECIES_PAL(OGERPON_CORNERSTONE, gMonPalette_Ogerpon_Cornerstone_Mask),
    SPECIES_PAL(OGERPON_WELLSPRING, gMonPalette_Ogerpon_Wellspring_Mask),
    ...
    SPECIES_PAL(TAUROS_PALDEA_BLAZE, gMonPalette_Tauros_Paldean_Blaze_Breed),
    SPECIES_PAL(TAUROS_PALDEA_AQUA, gMonPalette_Tauros_Paldean_Aqua_Breed),
    
    SPECIES_PAL(DECIDUEYE_HISUI, gMonPalette_Decidueye_Husian),
    SPECIES_PAL(AVALUGG_HISUI, gMonPalette_Avalugg_Husian),
    SPECIES_PAL(GOODRA_HISUI, gMonPalette_Goodra_Husian),
    SPECIES_PAL(SLIGGOO_HISUI, gMonPalette_Sliggoo_Husian),
    SPECIES_PAL(BRAVIARY_HISUI, gMonPalette_Braviary_Husian),
    SPECIES_PAL(ZOROARK_HISUI, gMonPalette_Zoroark_Husian),
    SPECIES_PAL(ZORUA_HISUI, gMonPalette_Zorua_Husian),
    SPECIES_PAL(LILLIGANT_HISUI, gMonPalette_Lilligant_Husian),
    SPECIES_PAL(SAMUROTT_HISUI, gMonPalette_Samurott_Husian),
    SPECIES_PAL(SNEASEL_HISUI, gMonPalette_Sneasel_Husian),
    SPECIES_PAL(QWILFISH_HISUI, gMonPalette_Qwilfish_Husian),
    SPECIES_PAL(TYPHLOSION_HISUI, gMonPalette_Typhlosion_Husian),
    SPECIES_PAL(ELECTRODE_HISUI, gMonPalette_Electrode_Husian),
    SPECIES_PAL(VOLTORB_HISUI, gMonPalette_Voltorb_Husian),
    SPECIES_PAL(ARCANINE_HISUI, gMonPalette_Arcanine_Husian),
    SPECIES_PAL(GROWLITHE_HISUI, gMonPalette_Growlithe_Husian),
