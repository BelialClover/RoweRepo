const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_GROWLITHE_HISUIAN] = gMonFootprint_Growlithe_Husian,
    [SPECIES_ARCANINE_HISUIAN] = gMonFootprint_Arcanine_Husian,
    [SPECIES_VOLTORB_HISUIAN] = gMonFootprint_Voltorb_Husian,
    [SPECIES_ELECTRODE_HISUIAN] = gMonFootprint_Electrode_Husian,
    [SPECIES_TYPHLOSION_HISUIAN] = gMonFootprint_Typhlosion_Husian,
    [SPECIES_QWILFISH_HISUIAN] = gMonFootprint_Qwilfish_Husian,
    [SPECIES_SNEASEL_HISUIAN] = gMonFootprint_Sneasel_Husian,
    [SPECIES_SAMUROTT_HISUIAN] = gMonFootprint_Samurott_Husian,
    [SPECIES_LILLIGANT_HISUIAN] = gMonFootprint_Lilligant_Husian,
    [SPECIES_ZORUA_HISUIAN] = gMonFootprint_Zorua_Husian,
    [SPECIES_ZOROARK_HISUIAN] = gMonFootprint_Zoroark_Husian,
    [SPECIES_BRAVIARY_HISUIAN] = gMonFootprint_Braviary_Husian,
    [SPECIES_SLIGGOO_HISUIAN] = gMonFootprint_Sliggoo_Husian,
    [SPECIES_GOODRA_HISUIAN] = gMonFootprint_Goodra_Husian,
    [SPECIES_AVALUGG_HISUIAN] = gMonFootprint_Avalugg_Husian,
    [SPECIES_DECIDUEYE_HISUIAN] = gMonFootprint_Decidueye_Husian,
