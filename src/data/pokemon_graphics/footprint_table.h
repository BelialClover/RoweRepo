const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_WOOPER_PALDEA] = gMonFootprint_Wooper,
    ...
    [SPECIES_GROWLITHE_HISUI] = gMonFootprint_Growlithe_Husian,
    [SPECIES_ARCANINE_HISUI] = gMonFootprint_Arcanine_Husian,
    [SPECIES_VOLTORB_HISUI] = gMonFootprint_Voltorb_Husian,
    [SPECIES_ELECTRODE_HISUI] = gMonFootprint_Electrode_Husian,
    [SPECIES_TYPHLOSION_HISUI] = gMonFootprint_Typhlosion_Husian,
    [SPECIES_QWILFISH_HISUI] = gMonFootprint_Qwilfish_Husian,
    [SPECIES_SNEASEL_HISUI] = gMonFootprint_Sneasel_Husian,
    [SPECIES_SAMUROTT_HISUI] = gMonFootprint_Samurott_Husian,
    [SPECIES_LILLIGANT_HISUI] = gMonFootprint_Lilligant_Husian,
    [SPECIES_ZORUA_HISUI] = gMonFootprint_Zorua_Husian,
    [SPECIES_ZOROARK_HISUI] = gMonFootprint_Zoroark_Husian,
    [SPECIES_BRAVIARY_HISUI] = gMonFootprint_Braviary_Husian,
    [SPECIES_SLIGGOO_HISUI] = gMonFootprint_Sliggoo_Husian,
    [SPECIES_GOODRA_HISUI] = gMonFootprint_Goodra_Husian,
    [SPECIES_AVALUGG_HISUI] = gMonFootprint_Avalugg_Husian,
    [SPECIES_DECIDUEYE_HISUI] = gMonFootprint_Decidueye_Husian,
    [SPECIES_BASCULIN_WHITE_STRIPED] = gMonFootprint_Basculin_Whitestriped,
