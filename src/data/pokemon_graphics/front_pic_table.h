const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonFrontPic_Decidueye_Husian),
    SPECIES_SPRITE(AVALUGG_HISUIAN, gMonFrontPic_Avalugg_Husian),
    SPECIES_SPRITE(GOODRA_HISUIAN, gMonFrontPic_Goodra_Husian),
    SPECIES_SPRITE(SLIGGOO_HISUIAN, gMonFrontPic_Sliggoo_Husian),
    SPECIES_SPRITE(BRAVIARY_HISUIAN, gMonFrontPic_Braviary_Husian),
    SPECIES_SPRITE(ZOROARK_HISUIAN, gMonFrontPic_Zoroark_Husian),
    SPECIES_SPRITE(ZORUA_HISUIAN, gMonFrontPic_Zorua_Husian),
    SPECIES_SPRITE(LILLIGANT_HISUIAN, gMonFrontPic_Lilligant_Husian),
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonFrontPic_Samurott_Husian),
    SPECIES_SPRITE(SNEASEL_HISUIAN, gMonFrontPic_Sneasel_Husian),
    SPECIES_SPRITE(QWILFISH_HISUIAN, gMonFrontPic_Qwilfish_Husian),
    SPECIES_SPRITE(TYPHLOSION_HISUIAN, gMonFrontPic_Typhlosion_Husian),
    SPECIES_SPRITE(ELECTRODE_HISUIAN, gMonFrontPic_Electrode_Husian),
    SPECIES_SPRITE(VOLTORB_HISUIAN, gMonFrontPic_Voltorb_Husian),
    SPECIES_SPRITE(ARCANINE_HISUIAN, gMonFrontPic_Arcanine_Husian),
    SPECIES_SPRITE(GROWLITHE_HISUIAN, gMonFrontPic_Growlithe_Husian),
    ...
    SPECIES_SPRITE(SQUAWKABILLY_WHITE_PLUMAGE,  gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_YELLOW_PLUMAGE, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_BLUE_PLUMAGE,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_GREEN_PLUMAGE,  gMonFrontPic_CircledQuestionMark), //Unused
    ...
    SPECIES_SPRITE(OINKOLOGNE_FEMALE, gMonFrontPic_Oinkologne_Female),
