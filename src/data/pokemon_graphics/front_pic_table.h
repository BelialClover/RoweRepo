const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(WOOPER_PALDEA, gMonFrontPic_Wooper_Paldea),
    ...
    SPECIES_SPRITE(DECIDUEYE_HISUI, gMonFrontPic_Decidueye_Husian),
    SPECIES_SPRITE(AVALUGG_HISUI, gMonFrontPic_Avalugg_Husian),
    SPECIES_SPRITE(GOODRA_HISUI, gMonFrontPic_Goodra_Husian),
    SPECIES_SPRITE(SLIGGOO_HISUI, gMonFrontPic_Sliggoo_Husian),
    SPECIES_SPRITE(BRAVIARY_HISUI, gMonFrontPic_Braviary_Husian),
    SPECIES_SPRITE(ZOROARK_HISUI, gMonFrontPic_Zoroark_Husian),
    SPECIES_SPRITE(ZORUA_HISUI, gMonFrontPic_Zorua_Husian),
    SPECIES_SPRITE(LILLIGANT_HISUI, gMonFrontPic_Lilligant_Husian),
    SPECIES_SPRITE(SAMUROTT_HISUI, gMonFrontPic_Samurott_Husian),
    SPECIES_SPRITE(SNEASEL_HISUI, gMonFrontPic_Sneasel_Husian),
    SPECIES_SPRITE(QWILFISH_HISUI, gMonFrontPic_Qwilfish_Husian),
    SPECIES_SPRITE(TYPHLOSION_HISUI, gMonFrontPic_Typhlosion_Husian),
    SPECIES_SPRITE(ELECTRODE_HISUI, gMonFrontPic_Electrode_Husian),
    SPECIES_SPRITE(VOLTORB_HISUI, gMonFrontPic_Voltorb_Husian),
    SPECIES_SPRITE(ARCANINE_HISUI, gMonFrontPic_Arcanine_Husian),
    SPECIES_SPRITE(GROWLITHE_HISUI, gMonFrontPic_Growlithe_Husian),
    ...
    SPECIES_SPRITE(GOUGING_FIRE, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(RAGING_BOLT, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(IRON_BOULDER, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(IRON_CROWN, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(TERAPAGOS, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(PECHARUNT, gMonFrontPic_Ogerpon),
    SPECIES_SPRITE(ZERAORA_MEGA, gMonFrontPic_Zeraora_Mega),
    SPECIES_SPRITE(VENUSAUR_MEGA_G, gMonFrontPic_Venusaur_Mega_G),
    SPECIES_SPRITE(URSHIFU_MEGA_SINGLE_STRIKE, gMonFrontPic_Urshifu_Mega_Single_Strike),
    SPECIES_SPRITE(URSHIFU_MEGA_RAPID_STRIKE, gMonFrontPic_Urshifu_Mega_Rapid_Strike),
    SPECIES_SPRITE(TOXTRICITY_MEGA_LOW_KEY, gMonFrontPic_Toxtricity_Mega_Low_Key),
    SPECIES_SPRITE(TOXTRICITY_MEGA, gMonFrontPic_Toxtricity_Mega),
    SPECIES_SPRITE(TATSUGIRI_MEGA_STRETCHY, gMonFrontPic_Tatsugiri_Mega_Stretchy),
    SPECIES_SPRITE(TATSUGIRI_MEGA_CURLY, gMonFrontPic_Tatsugiri_Mega_Curly),
    SPECIES_SPRITE(TATSUGIRI_MEGA_DROOPY, gMonFrontPic_Tatsugiri_Mega_Droopy),
    SPECIES_SPRITE(STARAPTOR_MEGA, gMonFrontPic_Staraptor_Mega),
    SPECIES_SPRITE(SCOVILLAIN_MEGA, gMonFrontPic_Scovillain_Mega),
    SPECIES_SPRITE(SANDSLASH_MEGA_ALOLA, gMonFrontPic_Sandslash_Mega_Alolan),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonFrontPic_Rillaboom_Mega),
    SPECIES_SPRITE(CINDERACE_MEGA, gMonFrontPic_Cinderace_Mega),
    SPECIES_SPRITE(MEOWSTIC_MEGA_F, gMonFrontPic_Meowstic_Mega_Female),
    SPECIES_SPRITE(MEOWSTIC_MEGA, gMonFrontPic_Meowstic_Mega),
    SPECIES_SPRITE(MELMETAL_MEGA, gMonFrontPic_Melmetal_Mega),
    SPECIES_SPRITE(MAGEARNA_MEGA, gMonFrontPic_Magearna_Mega),
    SPECIES_SPRITE(LUCARIO_MEGA_Z, gMonFrontPic_Lucario_Mega_Z),
    SPECIES_SPRITE(INTELEON_MEGA, gMonFrontPic_Inteleon_Mega),
    SPECIES_SPRITE(HEATRAN_MEGA, gMonFrontPic_Heatran_Mega),
    SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonFrontPic_Grimmsnarl_Mega),
    SPECIES_SPRITE(GOLURK_MEGA, gMonFrontPic_Golurk_Mega),
    SPECIES_SPRITE(GOLISOPOD_MEGA, gMonFrontPic_Golisopod_Mega),
    SPECIES_SPRITE(GARCHOMP_MEGA_Z, gMonFrontPic_Garchomp_Mega_Z),
    SPECIES_SPRITE(GLIMMORA_MEGA, gMonFrontPic_Glimmora_Mega),
    SPECIES_SPRITE(DARKRAI_MEGA, gMonFrontPic_Darkrai_Mega),
    SPECIES_SPRITE(CRABOMINABLE_MEGA, gMonFrontPic_Crabominable_Mega),
    SPECIES_SPRITE(CHIMECHO_MEGA, gMonFrontPic_Chimecho_Mega),
    SPECIES_SPRITE(BLASTOISE_MEGA_G, gMonFrontPic_Blastoise_Mega_G),
    SPECIES_SPRITE(BAXCALIBUR_MEGA, gMonFrontPic_Baxcalibur_Mega),
    SPECIES_SPRITE(ARBOK_MEGA, gMonFrontPic_Arbok_Mega),
    SPECIES_SPRITE(ABSOL_MEGA_Z, gMonFrontPic_Absol_Mega_Z),
    SPECIES_SPRITE(VANILLUXE_MEGA, gMonFrontPic_Vanilluxe_Mega),
    SPECIES_SPRITE(TYPHLOSION_HISUI_MEGA, gMonFrontPic_Typhlosion_Hisui_Mega),
    SPECIES_SPRITE(TYPHLOSION_MEGA, gMonFrontPic_Typhlosion_Mega),
    SPECIES_SPRITE(TSAREENA_MEGA, gMonFrontPic_Tsareena_Mega),
    SPECIES_SPRITE(TOUCANNON_MEGA, gMonFrontPic_Toucannon_Mega),
    SPECIES_SPRITE(STARMIE_MEGA_REDUX, gMonFrontPic_Starmie_Mega_Redux),
    SPECIES_SPRITE(CLEFABLE_MEGA_REDUX, gMonFrontPic_Clefable_Mega_Redux),
    SPECIES_SPRITE(TINKATON_MEGA, gMonFrontPic_Tinkaton_Mega),
    SPECIES_SPRITE(SLOWKING_GALAR_MEGA, gMonFrontPic_Slowking_Galar_Mega),
    SPECIES_SPRITE(SLOWKING_MEGA, gMonFrontPic_Slowking_Mega),
    SPECIES_SPRITE(SLOWBRO_GALAR_MEGA, gMonFrontPic_Slowbro_Galar_Mega),
    SPECIES_SPRITE(SHUCKLE_MEGA, gMonFrontPic_Shuckle_Mega),
    SPECIES_SPRITE(SHEDINJA_MEGA, gMonFrontPic_Shedinja_Mega),
    SPECIES_SPRITE(SERPERIOR_MEGA, gMonFrontPic_Serperior_Mega),
    SPECIES_SPRITE(SANDSLASH_MEGA, gMonFrontPic_Sandslash_Mega),
    SPECIES_SPRITE(SAMUROTT_HISUI_MEGA, gMonFrontPic_Samurott_Hisui_Mega),
    SPECIES_SPRITE(SAMUROTT_MEGA, gMonFrontPic_Samurott_Mega),
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonFrontPic_Ribombee_Mega),
    SPECIES_SPRITE(QUAGSIRE_MEGA, gMonFrontPic_Quagsire_Mega),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonFrontPic_Milotic_Mega),
    SPECIES_SPRITE(LUXRAY_MEGA, gMonFrontPic_Luxray_Mega),
    SPECIES_SPRITE(LANTURN_MEGA, gMonFrontPic_Lanturn_Mega),
    SPECIES_SPRITE(KROOKODILE_MEGA, gMonFrontPic_Krookodile_Mega),
    SPECIES_SPRITE(FLYGON_MEGA, gMonFrontPic_Flygon_Mega),
    SPECIES_SPRITE(DEWGONG_MEGA, gMonFrontPic_Dewgong_Mega),
    SPECIES_SPRITE(CROBAT_MEGA, gMonFrontPic_Crobat_Mega),
    SPECIES_SPRITE(CLODSIRE_MEGA, gMonFrontPic_Clodsire_Mega),
    SPECIES_SPRITE(BRELOOM_MEGA, gMonFrontPic_Breloom_Mega),
    SPECIES_SPRITE(RAICHU_MEGA_Y, gMonFrontPic_Raichu_Mega_Y),
    SPECIES_SPRITE(RAICHU_MEGA_X, gMonFrontPic_Raichu_Mega_X),
    SPECIES_SPRITE(FLOETTE_MEGA, gMonFrontPic_Floette_Mega),
    SPECIES_SPRITE(FALINKS_MEGA, gMonFrontPic_Falinks_Mega),
    SPECIES_SPRITE(DRAMPA_MEGA, gMonFrontPic_Drampa_Mega),
    SPECIES_SPRITE(ZYGARDE_MEGA, gMonFrontPic_Zygarde_Mega),
    SPECIES_SPRITE(HAWLUCHA_MEGA, gMonFrontPic_Hawlucha_Mega),
    SPECIES_SPRITE(DRAGALGE_MEGA, gMonFrontPic_Dragalge_Mega),
    SPECIES_SPRITE(BARBARACLE_MEGA, gMonFrontPic_Barbaracle_Mega),
    SPECIES_SPRITE(MALAMAR_MEGA, gMonFrontPic_Malamar_Mega),
    SPECIES_SPRITE(PYROAR_MEGA, gMonFrontPic_Pyroar_Mega),
    SPECIES_SPRITE(GRENINJA_MEGA, gMonFrontPic_Greninja_Mega),
    SPECIES_SPRITE(CHESNAUGHT_MEGA, gMonFrontPic_Chesnaught_Mega),
    SPECIES_SPRITE(DELPHOX_MEGA, gMonFrontPic_Delphox_Mega),
    SPECIES_SPRITE(CHANDELURE_MEGA, gMonFrontPic_Chandelure_Mega),
    SPECIES_SPRITE(EELEKTROSS_MEGA, gMonFrontPic_Eelektross_Mega),
    SPECIES_SPRITE(SCRAFTY_MEGA, gMonFrontPic_Scrafty_Mega),
    SPECIES_SPRITE(SCOLIPEDE_MEGA, gMonFrontPic_Scolipede_Mega),
    SPECIES_SPRITE(EXCADRILL_MEGA, gMonFrontPic_Excadrill_Mega),
    SPECIES_SPRITE(EMBOAR_MEGA, gMonFrontPic_Emboar_Mega),
    SPECIES_SPRITE(FROSLASS_MEGA, gMonFrontPic_Froslass_Mega),
    SPECIES_SPRITE(SKARMORY_MEGA, gMonFrontPic_Skarmory_Mega),
    SPECIES_SPRITE(FERALIGATR_MEGA, gMonFrontPic_Feraligatr_Mega),
    SPECIES_SPRITE(MEGANIUM_MEGA, gMonFrontPic_Meganium_Mega),
    SPECIES_SPRITE(STARMIE_MEGA, gMonFrontPic_Starmie_Mega),
    SPECIES_SPRITE(DRAGONITE_MEGA, gMonFrontPic_Dragonite_Mega),
    SPECIES_SPRITE(VICTREEBEL_MEGA, gMonFrontPic_Victreebel_Mega),
    SPECIES_SPRITE(CLEFABLE_MEGA, gMonFrontPic_Clefable_Mega),
    SPECIES_SPRITE(SNORLAX_MEGA, gMonFrontPic_Snorlax_Mega),
    SPECIES_SPRITE(SANDACONDA_MEGA, gMonFrontPic_Sandaconda_Mega),
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonFrontPic_Orbeetle_Mega),
    SPECIES_SPRITE(MACHAMP_MEGA, gMonFrontPic_Machamp_Mega),
    SPECIES_SPRITE(LAPRAS_MEGA, gMonFrontPic_Lapras_Mega),
    SPECIES_SPRITE(KINGLER_MEGA, gMonFrontPic_Kingler_Mega),
    SPECIES_SPRITE(HATTERENE_MEGA, gMonFrontPic_Hatterene_Mega),
    SPECIES_SPRITE(GARBODOR_MEGA, gMonFrontPic_Garbodor_Mega),
    SPECIES_SPRITE(FLAPPLE_MEGA, gMonFrontPic_Flapple_Mega),
    SPECIES_SPRITE(DREDNAW_MEGA, gMonFrontPic_Drednaw_Mega),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonFrontPic_Corviknight_Mega),
    SPECIES_SPRITE(COALOSSAL_MEGA, gMonFrontPic_Coalossal_Mega),
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonFrontPic_Centiskorch_Mega),
    SPECIES_SPRITE(BUTTERFREE_MEGA, gMonFrontPic_Butterfree_Mega),
    SPECIES_SPRITE(APPLETUN_MEGA, gMonFrontPic_Appletun_Mega),
    SPECIES_SPRITE(ALCREMIE_MEGA, gMonFrontPic_Alcremie_Mega),
    ...
    SPECIES_SPRITE(RATTATA_ALOLA, gMonFrontPic_RattataAlola),
    SPECIES_SPRITE(RATICATE_ALOLA, gMonFrontPic_RaticateAlola),
    SPECIES_SPRITE(RAICHU_ALOLA, gMonFrontPic_RaichuAlola),
    SPECIES_SPRITE(SANDSHREW_ALOLA, gMonFrontPic_SandshrewAlola),
    SPECIES_SPRITE(SANDSLASH_ALOLA, gMonFrontPic_SandslashAlola),
    SPECIES_SPRITE(VULPIX_ALOLA, gMonFrontPic_VulpixAlola),
    SPECIES_SPRITE(NINETALES_ALOLA, gMonFrontPic_NinetalesAlola),
    SPECIES_SPRITE(DIGLETT_ALOLA, gMonFrontPic_DiglettAlola),
    SPECIES_SPRITE(DUGTRIO_ALOLA, gMonFrontPic_DugtrioAlola),
    SPECIES_SPRITE(MEOWTH_ALOLA, gMonFrontPic_MeowthAlola),
    SPECIES_SPRITE(PERSIAN_ALOLA, gMonFrontPic_PersianAlola),
    SPECIES_SPRITE(GEODUDE_ALOLA, gMonFrontPic_GeodudeAlola),
    SPECIES_SPRITE(GRAVELER_ALOLA, gMonFrontPic_GravelerAlola),
    SPECIES_SPRITE(GOLEM_ALOLA, gMonFrontPic_GolemAlola),
    SPECIES_SPRITE(GRIMER_ALOLA, gMonFrontPic_GrimerAlola),
    SPECIES_SPRITE(MUK_ALOLA, gMonFrontPic_MukAlola),
    SPECIES_SPRITE(EXEGGUTOR_ALOLA, gMonFrontPic_ExeggutorAlola),
    SPECIES_SPRITE(MAROWAK_ALOLA, gMonFrontPic_MarowakAlola),

    SPECIES_SPRITE(MEOWTH_GALAR, gMonFrontPic_MeowthGalar),
    SPECIES_SPRITE(PONYTA_GALAR, gMonFrontPic_PonytaGalar),
    SPECIES_SPRITE(RAPIDASH_GALAR, gMonFrontPic_RapidashGalar),
    SPECIES_SPRITE(SLOWPOKE_GALAR, gMonFrontPic_SlowpokeGalar),
    SPECIES_SPRITE(SLOWBRO_GALAR, gMonFrontPic_SlowbroGalar),
    SPECIES_SPRITE(FARFETCHD_GALAR, gMonFrontPic_FarfetchdGalar),
    SPECIES_SPRITE(WEEZING_GALAR, gMonFrontPic_WeezingGalar),
    SPECIES_SPRITE(MR_MIME_GALAR, gMonFrontPic_MrMimeGalar),
    SPECIES_SPRITE(ARTICUNO_GALAR, gMonFrontPic_ArticunoGalar),
    SPECIES_SPRITE(ZAPDOS_GALAR, gMonFrontPic_ZapdosGalar),
    SPECIES_SPRITE(MOLTRES_GALAR, gMonFrontPic_MoltresGalar),
    SPECIES_SPRITE(SLOWKING_GALAR, gMonFrontPic_SlowkingGalar),
    SPECIES_SPRITE(CORSOLA_GALAR, gMonFrontPic_CorsolaGalar),
    SPECIES_SPRITE(ZIGZAGOON_GALAR, gMonFrontPic_ZigzagoonGalar),
    SPECIES_SPRITE(LINOONE_GALAR, gMonFrontPic_LinooneGalar),
    SPECIES_SPRITE(DARUMAKA_GALAR, gMonFrontPic_DarumakaGalar),
    SPECIES_SPRITE(DARMANITAN_GALAR, gMonFrontPic_DarmanitanGalar),
    SPECIES_SPRITE(YAMASK_GALAR, gMonFrontPic_YamaskGalar),
    SPECIES_SPRITE(STUNFISK_GALAR, gMonFrontPic_StunfiskGalar),
    ...
    SPECIES_SPRITE(PIKACHU_PHD, gMonFrontPic_PikachuPhD),
    SPECIES_SPRITE(PIKACHU_LIBRE, gMonFrontPic_PikachuLibre),

    SPECIES_SPRITE(PIKACHU_ORIGINAL, gMonFrontPic_PikachuOriginalCap),
    SPECIES_SPRITE(PIKACHU_HOENN, gMonFrontPic_PikachuHoennCap),
    SPECIES_SPRITE(PIKACHU_SINNOH, gMonFrontPic_PikachuSinnohCap),
    SPECIES_SPRITE(PIKACHU_UNOVA, gMonFrontPic_PikachuUnovaCap),
    SPECIES_SPRITE(PIKACHU_KALOS, gMonFrontPic_PikachuKalosCap),
    SPECIES_SPRITE(PIKACHU_ALOLA, gMonFrontPic_PikachuAlolaCap),
    SPECIES_SPRITE(PIKACHU_PARTNER, gMonFrontPic_PikachuPartnerCap),
    SPECIES_SPRITE(PIKACHU_WORLD, gMonFrontPic_PikachuWorldCap),
    ...
    SPECIES_SPRITE(UNOWN_EXCLAMATION, gMonFrontPic_UnownExclamationMark),
    SPECIES_SPRITE(UNOWN_QUESTION, gMonFrontPic_UnownQuestionMark),
    ...
    SPECIES_SPRITE(BURMY_SANDY, gMonFrontPic_BurmySandyCloak),
    SPECIES_SPRITE(BURMY_TRASH, gMonFrontPic_BurmyTrashCloak),

    SPECIES_SPRITE(WORMADAM_SANDY, gMonFrontPic_WormadamSandyCloak),
    SPECIES_SPRITE(WORMADAM_TRASH, gMonFrontPic_WormadamTrashCloak),

    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonFrontPic_CherrimSunshine),

    SPECIES_SPRITE(SHELLOS_EAST, gMonFrontPic_ShellosEastSea),

    SPECIES_SPRITE(GASTRODON_EAST, gMonFrontPic_GastrodonEastSea),
    ...
    SPECIES_SPRITE(VIVILLON_POKEBALL, gMonFrontPic_VivillonPokeBall),

    SPECIES_SPRITE(FLABEBE_YELLOW, gMonFrontPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_ORANGE, gMonFrontPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_BLUE, gMonFrontPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_WHITE, gMonFrontPic_Flabebe),

    SPECIES_SPRITE(FLOETTE_YELLOW, gMonFrontPic_Floette),
    SPECIES_SPRITE(FLOETTE_ORANGE, gMonFrontPic_Floette),
    SPECIES_SPRITE(FLOETTE_BLUE, gMonFrontPic_Floette),
    SPECIES_SPRITE(FLOETTE_WHITE, gMonFrontPic_Floette),
    SPECIES_SPRITE(FLOETTE_ETERNAL, gMonFrontPic_FloetteEternalFlower),

    SPECIES_SPRITE(FLORGES_YELLOW, gMonFrontPic_Florges),
    SPECIES_SPRITE(FLORGES_ORANGE, gMonFrontPic_Florges),
    SPECIES_SPRITE(FLORGES_BLUE, gMonFrontPic_Florges),
    SPECIES_SPRITE(FLORGES_WHITE, gMonFrontPic_Florges),

    SPECIES_SPRITE(FURFROU_HEART, gMonFrontPic_FurfrouHeartTrim),
    SPECIES_SPRITE(FURFROU_STAR, gMonFrontPic_FurfrouStarTrim),
    SPECIES_SPRITE(FURFROU_DIAMOND, gMonFrontPic_FurfrouDiamondTrim),
    SPECIES_SPRITE(FURFROU_DEBUTANTE, gMonFrontPic_FurfrouDebutanteTrim),
    SPECIES_SPRITE(FURFROU_MATRON, gMonFrontPic_FurfrouMatronTrim),
    SPECIES_SPRITE(FURFROU_DANDY, gMonFrontPic_FurfrouDandyTrim),
    SPECIES_SPRITE(FURFROU_LA_REINE, gMonFrontPic_FurfrouLaReineTrim),
    SPECIES_SPRITE(FURFROU_KABUKI, gMonFrontPic_FurfrouKabukiTrim),
    SPECIES_SPRITE(FURFROU_PHARAOH, gMonFrontPic_FurfrouPharaohTrim),
    ...
    SPECIES_SPRITE(MINIOR_METEOR_ORANGE, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_YELLOW, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_GREEN,  gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_BLUE,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_INDIGO, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_VIOLET, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_ORANGE,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_YELLOW,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_GREEN,    gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_BLUE,     gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_INDIGO,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_VIOLET,   gMonFrontPic_CircledQuestionMark), //Unused
    ...
    SPECIES_SPRITE(EISCUE_NOICE, gMonFrontPic_EiscueNoiceFace),

    SPECIES_SPRITE(INDEEDEE_F, gMonFrontPic_IndeedeeF),

    SPECIES_SPRITE(MORPEKO_HANGRY, gMonFrontPic_MorpekoHangry),

    SPECIES_SPRITE(ZACIAN_CROWNED, gMonFrontPic_ZacianCrownedSword),

    SPECIES_SPRITE(ZAMAZENTA_CROWNED, gMonFrontPic_ZamazentaCrownedShield),

    SPECIES_SPRITE(ETERNATUS_ETERNAMAX, gMonFrontPic_Eternatus/*Eternamax*/),

    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE, gMonFrontPic_UrshifuRapidStrikeStyle),

    SPECIES_SPRITE(ZARUDE_DADA, gMonFrontPic_ZarudeDada),

    SPECIES_SPRITE(CALYREX_ICE, gMonFrontPic_CalyrexIceRider),
    SPECIES_SPRITE(CALYREX_SHADOW, gMonFrontPic_CalyrexShadowRider),
    ...
    //Gen 9
    SPECIES_SPRITE(OGERPON_HEARTHFLAME, gMonFrontPic_Ogerpon_Hearthflame_Mask),
    SPECIES_SPRITE(OGERPON_CORNERSTONE, gMonFrontPic_Ogerpon_Cornerstone_Mask),
    SPECIES_SPRITE(OGERPON_WELLSPRING, gMonFrontPic_Ogerpon_Wellspring_Mask),

    SPECIES_SPRITE(SQUAWKABILLY_WHITE,  gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_YELLOW, gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_BLUE,   gMonFrontPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(SQUAWKABILLY_GREEN,  gMonFrontPic_CircledQuestionMark), //Unused
    ...
    SPECIES_SPRITE(TAUROS_PALDEA_BLAZE, gMonFrontPic_Tauros_Paldean_Blaze_Breed),
    SPECIES_SPRITE(TAUROS_PALDEA_AQUA, gMonFrontPic_Tauros_Paldean_Aqua_Breed),

    SPECIES_SPRITE(OINKOLOGNE_F, gMonFrontPic_Oinkologne_F),
