const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(WOOPER_PALDEA, gMonBackPic_Wooper_Paldea),
    ...
    SPECIES_SPRITE(DECIDUEYE_HISUI, gMonBackPic_Decidueye_Husian),
    SPECIES_SPRITE(AVALUGG_HISUI, gMonBackPic_Avalugg_Husian),
    SPECIES_SPRITE(GOODRA_HISUI, gMonBackPic_Goodra_Husian),
    SPECIES_SPRITE(SLIGGOO_HISUI, gMonBackPic_Sliggoo_Husian),
    SPECIES_SPRITE(BRAVIARY_HISUI, gMonBackPic_Braviary_Husian),
    SPECIES_SPRITE(ZOROARK_HISUI, gMonBackPic_Zoroark_Husian),
    SPECIES_SPRITE(ZORUA_HISUI, gMonBackPic_Zorua_Husian),
    SPECIES_SPRITE(LILLIGANT_HISUI, gMonBackPic_Lilligant_Husian),
    SPECIES_SPRITE(SAMUROTT_HISUI, gMonBackPic_Samurott_Husian),
    SPECIES_SPRITE(SNEASEL_HISUI, gMonBackPic_Sneasel_Husian),
    SPECIES_SPRITE(QWILFISH_HISUI, gMonBackPic_Qwilfish_Husian),
    SPECIES_SPRITE(TYPHLOSION_HISUI, gMonBackPic_Typhlosion_Husian),
    SPECIES_SPRITE(ELECTRODE_HISUI, gMonBackPic_Electrode_Husian),
    SPECIES_SPRITE(VOLTORB_HISUI, gMonBackPic_Voltorb_Husian),
    SPECIES_SPRITE(ARCANINE_HISUI, gMonBackPic_Arcanine_Husian),
    SPECIES_SPRITE(GROWLITHE_HISUI, gMonBackPic_Growlithe_Husian),
    ...
    SPECIES_SPRITE(OINKOLOGNE_F, gMonBackPic_Oinkologne_F),
    ...
    SPECIES_SPRITE(GOUGING_FIRE, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(RAGING_BOLT, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(IRON_BOULDER, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(IRON_CROWN, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(TERAPAGOS, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(PECHARUNT, gMonBackPic_Ogerpon),
    SPECIES_SPRITE(ZERAORA_MEGA, gMonBackPic_Zeraora_Mega),
    SPECIES_SPRITE(VENUSAUR_MEGA_G, gMonBackPic_Venusaur_Mega_G),
    SPECIES_SPRITE(URSHIFU_MEGA_SINGLE_STRIKE, gMonBackPic_Urshifu_Mega_Single_Strike),
    SPECIES_SPRITE(URSHIFU_MEGA_RAPID_STRIKE, gMonBackPic_Urshifu_Mega_Rapid_Strike),
    SPECIES_SPRITE(TOXTRICITY_MEGA_LOW_KEY, gMonBackPic_Toxtricity_Mega_Low_Key),
    SPECIES_SPRITE(TOXTRICITY_MEGA, gMonBackPic_Toxtricity_Mega),
    SPECIES_SPRITE(TATSUGIRI_MEGA_STRETCHY, gMonBackPic_Tatsugiri_Mega_Stretchy),
    SPECIES_SPRITE(TATSUGIRI_MEGA_CURLY, gMonBackPic_Tatsugiri_Mega_Curly),
    SPECIES_SPRITE(TATSUGIRI_MEGA_DROOPY, gMonBackPic_Tatsugiri_Mega_Droopy),
    SPECIES_SPRITE(STARAPTOR_MEGA, gMonBackPic_Staraptor_Mega),
    SPECIES_SPRITE(SCOVILLAIN_MEGA, gMonBackPic_Scovillain_Mega),
    SPECIES_SPRITE(SANDSLASH_MEGA_ALOLA, gMonBackPic_Sandslash_Mega_Alolan),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonBackPic_Rillaboom_Mega),
    SPECIES_SPRITE(CINDERACE_MEGA, gMonBackPic_Cinderace_Mega),
    SPECIES_SPRITE(MEOWSTIC_MEGA_F, gMonBackPic_Meowstic_Mega_Female),
    SPECIES_SPRITE(MEOWSTIC_MEGA, gMonBackPic_Meowstic_Mega),
    SPECIES_SPRITE(MELMETAL_MEGA, gMonBackPic_Melmetal_Mega),
    SPECIES_SPRITE(MAGEARNA_MEGA, gMonBackPic_Magearna_Mega),
    SPECIES_SPRITE(LUCARIO_MEGA_Z, gMonBackPic_Lucario_Mega_Z),
    SPECIES_SPRITE(INTELEON_MEGA, gMonBackPic_Inteleon_Mega),
    SPECIES_SPRITE(HEATRAN_MEGA, gMonBackPic_Heatran_Mega),
    SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonBackPic_Grimmsnarl_Mega),
    SPECIES_SPRITE(GOLURK_MEGA, gMonBackPic_Golurk_Mega),
    SPECIES_SPRITE(GOLISOPOD_MEGA, gMonBackPic_Golisopod_Mega),
    SPECIES_SPRITE(GARCHOMP_MEGA_Z, gMonBackPic_Garchomp_Mega_Z),
    SPECIES_SPRITE(GLIMMORA_MEGA, gMonBackPic_Glimmora_Mega),
    SPECIES_SPRITE(DARKRAI_MEGA, gMonBackPic_Darkrai_Mega),
    SPECIES_SPRITE(CRABOMINABLE_MEGA, gMonBackPic_Crabominable_Mega),
    SPECIES_SPRITE(CHIMECHO_MEGA, gMonBackPic_Chimecho_Mega),
    SPECIES_SPRITE(BLASTOISE_MEGA_G, gMonBackPic_Blastoise_Mega_G),
    SPECIES_SPRITE(BAXCALIBUR_MEGA, gMonBackPic_Baxcalibur_Mega),
    SPECIES_SPRITE(ARBOK_MEGA, gMonBackPic_Arbok_Mega),
    SPECIES_SPRITE(ABSOL_MEGA_Z, gMonBackPic_Absol_Mega_Z),
    SPECIES_SPRITE(VANILLUXE_MEGA, gMonBackPic_Vanilluxe_Mega),
    SPECIES_SPRITE(TYPHLOSION_HISUI_MEGA, gMonBackPic_Typhlosion_Hisui_Mega),
    SPECIES_SPRITE(TYPHLOSION_MEGA, gMonBackPic_Typhlosion_Mega),
    SPECIES_SPRITE(TSAREENA_MEGA, gMonBackPic_Tsareena_Mega),
    SPECIES_SPRITE(TOUCANNON_MEGA, gMonBackPic_Toucannon_Mega),
    SPECIES_SPRITE(STARMIE_MEGA_REDUX, gMonBackPic_Starmie_Mega_Redux),
    SPECIES_SPRITE(CLEFABLE_MEGA_REDUX, gMonBackPic_Clefable_Mega_Redux),
    SPECIES_SPRITE(TINKATON_MEGA, gMonBackPic_Tinkaton_Mega),
    SPECIES_SPRITE(SLOWKING_GALAR_MEGA, gMonBackPic_Slowking_Galar_Mega),
    SPECIES_SPRITE(SLOWKING_MEGA, gMonBackPic_Slowking_Mega),
    SPECIES_SPRITE(SLOWBRO_GALAR_MEGA, gMonBackPic_Slowbro_Galar_Mega),
    SPECIES_SPRITE(SHUCKLE_MEGA, gMonBackPic_Shuckle_Mega),
    SPECIES_SPRITE(SHEDINJA_MEGA, gMonBackPic_Shedinja_Mega),
    SPECIES_SPRITE(SERPERIOR_MEGA, gMonBackPic_Serperior_Mega),
    SPECIES_SPRITE(SANDSLASH_MEGA, gMonBackPic_Sandslash_Mega),
    SPECIES_SPRITE(SAMUROTT_HISUI_MEGA, gMonBackPic_Samurott_Hisui_Mega),
    SPECIES_SPRITE(SAMUROTT_MEGA, gMonBackPic_Samurott_Mega),
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonBackPic_Ribombee_Mega),
    SPECIES_SPRITE(QUAGSIRE_MEGA, gMonBackPic_Quagsire_Mega),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonBackPic_Milotic_Mega),
    SPECIES_SPRITE(LUXRAY_MEGA, gMonBackPic_Luxray_Mega),
    SPECIES_SPRITE(LANTURN_MEGA, gMonBackPic_Lanturn_Mega),
    SPECIES_SPRITE(KROOKODILE_MEGA, gMonBackPic_Krookodile_Mega),
    SPECIES_SPRITE(FLYGON_MEGA, gMonBackPic_Flygon_Mega),
    SPECIES_SPRITE(DEWGONG_MEGA, gMonBackPic_Dewgong_Mega),
    SPECIES_SPRITE(CROBAT_MEGA, gMonBackPic_Crobat_Mega),
    SPECIES_SPRITE(CLODSIRE_MEGA, gMonBackPic_Clodsire_Mega),
    SPECIES_SPRITE(BRELOOM_MEGA, gMonBackPic_Breloom_Mega),
    SPECIES_SPRITE(RAICHU_MEGA_Y, gMonBackPic_Raichu_Mega_Y),
    SPECIES_SPRITE(RAICHU_MEGA_X, gMonBackPic_Raichu_Mega_X),
    SPECIES_SPRITE(FLOETTE_MEGA, gMonBackPic_Floette_Mega),
    SPECIES_SPRITE(FALINKS_MEGA, gMonBackPic_Falinks_Mega),
    SPECIES_SPRITE(DRAMPA_MEGA, gMonBackPic_Drampa_Mega),
    SPECIES_SPRITE(ZYGARDE_MEGA, gMonBackPic_Zygarde_Mega),
    SPECIES_SPRITE(HAWLUCHA_MEGA, gMonBackPic_Hawlucha_Mega),
    SPECIES_SPRITE(DRAGALGE_MEGA, gMonBackPic_Dragalge_Mega),
    SPECIES_SPRITE(BARBARACLE_MEGA, gMonBackPic_Barbaracle_Mega),
    SPECIES_SPRITE(MALAMAR_MEGA, gMonBackPic_Malamar_Mega),
    SPECIES_SPRITE(PYROAR_MEGA, gMonBackPic_Pyroar_Mega),
    SPECIES_SPRITE(GRENINJA_MEGA, gMonBackPic_Greninja_Mega),
    SPECIES_SPRITE(CHESNAUGHT_MEGA, gMonBackPic_Chesnaught_Mega),
    SPECIES_SPRITE(DELPHOX_MEGA, gMonBackPic_Delphox_Mega),
    SPECIES_SPRITE(CHANDELURE_MEGA, gMonBackPic_Chandelure_Mega),
    SPECIES_SPRITE(EELEKTROSS_MEGA, gMonBackPic_Eelektross_Mega),
    SPECIES_SPRITE(SCRAFTY_MEGA, gMonBackPic_Scrafty_Mega),
    SPECIES_SPRITE(SCOLIPEDE_MEGA, gMonBackPic_Scolipede_Mega),
    SPECIES_SPRITE(EXCADRILL_MEGA, gMonBackPic_Excadrill_Mega),
    SPECIES_SPRITE(EMBOAR_MEGA, gMonBackPic_Emboar_Mega),
    SPECIES_SPRITE(FROSLASS_MEGA, gMonBackPic_Froslass_Mega),
    SPECIES_SPRITE(SKARMORY_MEGA, gMonBackPic_Skarmory_Mega),
    SPECIES_SPRITE(FERALIGATR_MEGA, gMonBackPic_Feraligatr_Mega),
    SPECIES_SPRITE(MEGANIUM_MEGA, gMonBackPic_Meganium_Mega),
    SPECIES_SPRITE(STARMIE_MEGA, gMonBackPic_Starmie_Mega),
    SPECIES_SPRITE(DRAGONITE_MEGA, gMonBackPic_Dragonite_Mega),
    SPECIES_SPRITE(VICTREEBEL_MEGA, gMonBackPic_Victreebel_Mega),
    SPECIES_SPRITE(CLEFABLE_MEGA, gMonBackPic_Clefable_Mega),
    SPECIES_SPRITE(SNORLAX_MEGA, gMonBackPic_Snorlax_Mega),
    SPECIES_SPRITE(SANDACONDA_MEGA, gMonBackPic_Sandaconda_Mega),
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonBackPic_Orbeetle_Mega),
    SPECIES_SPRITE(MACHAMP_MEGA, gMonBackPic_Machamp_Mega),
    SPECIES_SPRITE(LAPRAS_MEGA, gMonBackPic_Lapras_Mega),
    SPECIES_SPRITE(KINGLER_MEGA, gMonBackPic_Kingler_Mega),
    SPECIES_SPRITE(HATTERENE_MEGA, gMonBackPic_Hatterene_Mega),
    SPECIES_SPRITE(GARBODOR_MEGA, gMonBackPic_Garbodor_Mega),
    SPECIES_SPRITE(FLAPPLE_MEGA, gMonBackPic_Flapple_Mega),
    SPECIES_SPRITE(DREDNAW_MEGA, gMonBackPic_Drednaw_Mega),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonBackPic_Corviknight_Mega),
    SPECIES_SPRITE(COALOSSAL_MEGA, gMonBackPic_Coalossal_Mega),
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonBackPic_Centiskorch_Mega),
    SPECIES_SPRITE(BUTTERFREE_MEGA, gMonBackPic_Butterfree_Mega),
    SPECIES_SPRITE(APPLETUN_MEGA, gMonBackPic_Appletun_Mega),
    SPECIES_SPRITE(ALCREMIE_MEGA, gMonBackPic_Alcremie_Mega),
    ...
    SPECIES_SPRITE(OGERPON_HEARTHFLAME, gMonBackPic_Ogerpon_Hearthflame_Mask),
    SPECIES_SPRITE(OGERPON_CORNERSTONE, gMonBackPic_Ogerpon_Cornerstone_Mask),
    SPECIES_SPRITE(OGERPON_WELLSPRING, gMonBackPic_Ogerpon_Wellspring_Mask),
    ...
    SPECIES_SPRITE(TAUROS_PALDEA_BLAZE, gMonBackPic_Tauros_Paldean_Blaze_Breed),
    SPECIES_SPRITE(TAUROS_PALDEA_AQUA, gMonBackPic_Tauros_Paldean_Aqua_Breed),
    ...
    SPECIES_SPRITE(RATTATA_ALOLA, gMonBackPic_RattataAlola),
    SPECIES_SPRITE(RATICATE_ALOLA, gMonBackPic_RaticateAlola),
    SPECIES_SPRITE(RAICHU_ALOLA, gMonBackPic_RaichuAlola),
    SPECIES_SPRITE(SANDSHREW_ALOLA, gMonBackPic_SandshrewAlola),
    SPECIES_SPRITE(SANDSLASH_ALOLA, gMonBackPic_SandslashAlola),
    SPECIES_SPRITE(VULPIX_ALOLA, gMonBackPic_VulpixAlola),
    SPECIES_SPRITE(NINETALES_ALOLA, gMonBackPic_NinetalesAlola),
    SPECIES_SPRITE(DIGLETT_ALOLA, gMonBackPic_DiglettAlola),
    SPECIES_SPRITE(DUGTRIO_ALOLA, gMonBackPic_DugtrioAlola),
    SPECIES_SPRITE(MEOWTH_ALOLA, gMonBackPic_MeowthAlola),
    SPECIES_SPRITE(PERSIAN_ALOLA, gMonBackPic_PersianAlola),
    SPECIES_SPRITE(GEODUDE_ALOLA, gMonBackPic_GeodudeAlola),
    SPECIES_SPRITE(GRAVELER_ALOLA, gMonBackPic_GravelerAlola),
    SPECIES_SPRITE(GOLEM_ALOLA, gMonBackPic_GolemAlola),
    SPECIES_SPRITE(GRIMER_ALOLA, gMonBackPic_GrimerAlola),
    SPECIES_SPRITE(MUK_ALOLA, gMonBackPic_MukAlola),
    SPECIES_SPRITE(EXEGGUTOR_ALOLA, gMonBackPic_ExeggutorAlola),
    SPECIES_SPRITE(MAROWAK_ALOLA, gMonBackPic_MarowakAlola),

    SPECIES_SPRITE(MEOWTH_GALAR, gMonBackPic_MeowthGalar),
    SPECIES_SPRITE(PONYTA_GALAR, gMonBackPic_PonytaGalar),
    SPECIES_SPRITE(RAPIDASH_GALAR, gMonBackPic_RapidashGalar),
    SPECIES_SPRITE(SLOWPOKE_GALAR, gMonBackPic_SlowpokeGalar),
    SPECIES_SPRITE(SLOWBRO_GALAR, gMonBackPic_SlowbroGalar),
    SPECIES_SPRITE(FARFETCHD_GALAR, gMonBackPic_FarfetchdGalar),
    SPECIES_SPRITE(WEEZING_GALAR, gMonBackPic_WeezingGalar),
    SPECIES_SPRITE(MR_MIME_GALAR, gMonBackPic_MrMimeGalar),
    SPECIES_SPRITE(ARTICUNO_GALAR, gMonBackPic_ArticunoGalar),
    SPECIES_SPRITE(ZAPDOS_GALAR, gMonBackPic_ZapdosGalar),
    SPECIES_SPRITE(MOLTRES_GALAR, gMonBackPic_MoltresGalar),
    SPECIES_SPRITE(SLOWKING_GALAR, gMonBackPic_SlowkingGalar),
    SPECIES_SPRITE(CORSOLA_GALAR, gMonBackPic_CorsolaGalar),
    SPECIES_SPRITE(ZIGZAGOON_GALAR, gMonBackPic_ZigzagoonGalar),
    SPECIES_SPRITE(LINOONE_GALAR, gMonBackPic_LinooneGalar),
    SPECIES_SPRITE(DARUMAKA_GALAR, gMonBackPic_DarumakaGalar),
    SPECIES_SPRITE(DARMANITAN_GALAR, gMonBackPic_DarmanitanGalar),
    SPECIES_SPRITE(YAMASK_GALAR, gMonBackPic_YamaskGalar),
    SPECIES_SPRITE(STUNFISK_GALAR, gMonBackPic_StunfiskGalar),
    ...
    SPECIES_SPRITE(PIKACHU_PHD, gMonBackPic_PikachuPhD),
    SPECIES_SPRITE(PIKACHU_LIBRE, gMonBackPic_PikachuLibre),

    SPECIES_SPRITE(PIKACHU_ORIGINAL, gMonBackPic_PikachuOriginalCap),
    SPECIES_SPRITE(PIKACHU_HOENN, gMonBackPic_PikachuHoennCap),
    SPECIES_SPRITE(PIKACHU_SINNOH, gMonBackPic_PikachuSinnohCap),
    SPECIES_SPRITE(PIKACHU_UNOVA, gMonBackPic_PikachuUnovaCap),
    SPECIES_SPRITE(PIKACHU_KALOS, gMonBackPic_PikachuKalosCap),
    SPECIES_SPRITE(PIKACHU_ALOLA, gMonBackPic_PikachuAlolaCap),
    SPECIES_SPRITE(PIKACHU_PARTNER, gMonBackPic_PikachuPartnerCap),
    SPECIES_SPRITE(PIKACHU_WORLD, gMonBackPic_PikachuWorldCap),
    ...
    SPECIES_SPRITE(UNOWN_EXCLAMATION, gMonBackPic_UnownExclamationMark),
    SPECIES_SPRITE(UNOWN_QUESTION, gMonBackPic_UnownQuestionMark),
    ...
    SPECIES_SPRITE(BURMY_SANDY, gMonBackPic_BurmySandyCloak),
    SPECIES_SPRITE(BURMY_TRASH, gMonBackPic_BurmyTrashCloak),

    SPECIES_SPRITE(WORMADAM_SANDY, gMonBackPic_WormadamSandyCloak),
    SPECIES_SPRITE(WORMADAM_TRASH, gMonBackPic_WormadamTrashCloak),

    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonBackPic_CherrimSunshine),

    SPECIES_SPRITE(SHELLOS_EAST, gMonBackPic_ShellosEastSea),

    SPECIES_SPRITE(GASTRODON_EAST, gMonBackPic_GastrodonEastSea),
    ...
    SPECIES_SPRITE(VIVILLON_POKEBALL, gMonBackPic_VivillonPokeBall),

    SPECIES_SPRITE(FLABEBE_YELLOW, gMonBackPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_ORANGE, gMonBackPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_BLUE, gMonBackPic_Flabebe),
    SPECIES_SPRITE(FLABEBE_WHITE, gMonBackPic_Flabebe),

    SPECIES_SPRITE(FLOETTE_YELLOW, gMonBackPic_Floette),
    SPECIES_SPRITE(FLOETTE_ORANGE, gMonBackPic_Floette),
    SPECIES_SPRITE(FLOETTE_BLUE, gMonBackPic_Floette),
    SPECIES_SPRITE(FLOETTE_WHITE, gMonBackPic_Floette),
    SPECIES_SPRITE(FLOETTE_ETERNAL, gMonBackPic_FloetteEternalFlower),

    SPECIES_SPRITE(FLORGES_YELLOW, gMonBackPic_Florges),
    SPECIES_SPRITE(FLORGES_ORANGE, gMonBackPic_Florges),
    SPECIES_SPRITE(FLORGES_BLUE, gMonBackPic_Florges),
    SPECIES_SPRITE(FLORGES_WHITE, gMonBackPic_Florges),

    SPECIES_SPRITE(FURFROU_HEART, gMonBackPic_FurfrouHeartTrim),
    SPECIES_SPRITE(FURFROU_STAR, gMonBackPic_FurfrouStarTrim),
    SPECIES_SPRITE(FURFROU_DIAMOND, gMonBackPic_FurfrouDiamondTrim),
    SPECIES_SPRITE(FURFROU_DEBUTANTE, gMonBackPic_FurfrouDebutanteTrim),
    SPECIES_SPRITE(FURFROU_MATRON, gMonBackPic_FurfrouMatronTrim),
    SPECIES_SPRITE(FURFROU_DANDY, gMonBackPic_FurfrouDandyTrim),
    SPECIES_SPRITE(FURFROU_LA_REINE, gMonBackPic_FurfrouLaReineTrim),
    SPECIES_SPRITE(FURFROU_KABUKI, gMonBackPic_FurfrouKabukiTrim),
    SPECIES_SPRITE(FURFROU_PHARAOH, gMonBackPic_FurfrouPharaohTrim),
    ...
    SPECIES_SPRITE(MINIOR_METEOR_ORANGE, gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_YELLOW, gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_GREEN,  gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_BLUE,   gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_INDIGO, gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_METEOR_VIOLET, gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_ORANGE,   gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_YELLOW,   gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_GREEN,    gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_BLUE,     gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_INDIGO,   gMonBackPic_CircledQuestionMark), //Unused
    SPECIES_SPRITE(MINIOR_CORE_VIOLET,   gMonBackPic_CircledQuestionMark), //Unused
    ...
    SPECIES_SPRITE(MAGEARNA_ORIGINAL, gMonBackPic_MagearnaOriginalColor),
    ...
    SPECIES_SPRITE(EISCUE_NOICE, gMonBackPic_EiscueNoiceFace),

    SPECIES_SPRITE(INDEEDEE_F, gMonBackPic_IndeedeeF),

    SPECIES_SPRITE(MORPEKO_HANGRY, gMonBackPic_MorpekoHangry),

    SPECIES_SPRITE(ZACIAN_CROWNED, gMonBackPic_ZacianCrownedSword),

    SPECIES_SPRITE(ZAMAZENTA_CROWNED, gMonBackPic_ZamazentaCrownedShield),

    SPECIES_SPRITE(ETERNATUS_ETERNAMAX, gMonBackPic_Eternatus/*Eternamax*/),

    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE, gMonBackPic_UrshifuRapidStrikeStyle),

    SPECIES_SPRITE(ZARUDE_DADA, gMonBackPic_ZarudeDada),

    SPECIES_SPRITE(CALYREX_ICE, gMonBackPic_CalyrexIceRider),
    SPECIES_SPRITE(CALYREX_SHADOW, gMonBackPic_CalyrexShadowRider),
