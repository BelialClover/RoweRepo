const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonBackPic_Decidueye_Husian),
    SPECIES_SPRITE(AVALUGG_HISUIAN, gMonBackPic_Avalugg_Husian),
    SPECIES_SPRITE(GOODRA_HISUIAN, gMonBackPic_Goodra_Husian),
    SPECIES_SPRITE(SLIGGOO_HISUIAN, gMonBackPic_Sliggoo_Husian),
    SPECIES_SPRITE(BRAVIARY_HISUIAN, gMonBackPic_Braviary_Husian),
    SPECIES_SPRITE(ZOROARK_HISUIAN, gMonBackPic_Zoroark_Husian),
    SPECIES_SPRITE(ZORUA_HISUIAN, gMonBackPic_Zorua_Husian),
    SPECIES_SPRITE(LILLIGANT_HISUIAN, gMonBackPic_Lilligant_Husian),
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonBackPic_Samurott_Husian),
    SPECIES_SPRITE(SNEASEL_HISUIAN, gMonBackPic_Sneasel_Husian),
    SPECIES_SPRITE(QWILFISH_HISUIAN, gMonBackPic_Qwilfish_Husian),
    SPECIES_SPRITE(TYPHLOSION_HISUIAN, gMonBackPic_Typhlosion_Husian),
    SPECIES_SPRITE(ELECTRODE_HISUIAN, gMonBackPic_Electrode_Husian),
    SPECIES_SPRITE(VOLTORB_HISUIAN, gMonBackPic_Voltorb_Husian),
    SPECIES_SPRITE(ARCANINE_HISUIAN, gMonBackPic_Arcanine_Husian),
    SPECIES_SPRITE(GROWLITHE_HISUIAN, gMonBackPic_Growlithe_Husian),
    ...
    SPECIES_SPRITE(OINKOLOGNE_FEMALE, gMonBackPic_Oinkologne),
