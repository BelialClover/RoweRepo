...
const u8 gEnemyMonElevation[NUM_SPECIES] =
{
    ...
    // Galarian Forms
    [SPECIES_WEEZING_GALAR] = 3,
    [SPECIES_YAMASK_GALAR] = 4,
    // Misc Forms
    [SPECIES_GIRATINA_ORIGIN] = 7,
    [SPECIES_THUNDURUS_THERIAN] = 7,

    [SPECIES_CLEFABLE_MEGA] = 7,
    [SPECIES_CLEFABLE_MEGA_REDUX] = 7,
    [SPECIES_DELPHOX_MEGA] = 8,
    [SPECIES_CROBAT_MEGA] = 8,
    [SPECIES_DARKRAI_MEGA] = 4,
    [SPECIES_FLYGON_MEGA] = 7,
    [SPECIES_SLOWKING_GALAR_MEGA] = 7,
    [SPECIES_DRAGALGE_MEGA] = 5,
    [SPECIES_DRAGONITE_MEGA] = 5,
    [SPECIES_SHEDINJA_MEGA] = 5,
};
