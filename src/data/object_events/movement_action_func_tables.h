...
u8 MovementAction_Down_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Up_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Left_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Right_Follower(struct ObjectEvent *, struct Sprite *);

u8 MovementAction_Step_Down_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Up_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Left_Follower(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Right_Follower(struct ObjectEvent *, struct Sprite *);

u8 MovementAction_Step_Down_Follower_Speed0(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Up_Follower_Speed0(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Left_Follower_Speed0(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_Step_Right_Follower_Speed0(struct ObjectEvent *, struct Sprite *);

u8 MovementAction_WalkInPlaceSlow_Step1_Follower(struct ObjectEvent *, struct Sprite *);
...
u8 (*const gMovementActionFuncs_FaceDown_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_FaceUp_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_FaceLeft_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_FaceRight_Follower[])(struct ObjectEvent *, struct Sprite *);

u8 (*const gMovementActionFuncs_StepDown_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepUp_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepLeft_Follower[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepRight_Follower[])(struct ObjectEvent *, struct Sprite *);

u8 (*const gMovementActionFuncs_StepDown_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepUp_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepLeft_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *);
u8 (*const gMovementActionFuncs_StepRight_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *);
...
u8 (*const *const gMovementActionFuncs[])(struct ObjectEvent *, struct Sprite *) = {
    [MOVEMENT_ACTION_FACE_DOWN_FOLLOWER] = gMovementActionFuncs_FaceDown_Follower,
    [MOVEMENT_ACTION_FACE_UP_FOLLOWER] = gMovementActionFuncs_FaceUp_Follower,
    [MOVEMENT_ACTION_FACE_LEFT_FOLLOWER] = gMovementActionFuncs_FaceLeft_Follower,
    [MOVEMENT_ACTION_FACE_RIGHT_FOLLOWER] = gMovementActionFuncs_FaceRight_Follower,

    [MOVEMENT_ACTION_STEP_DOWN_FOLLOWER]  = gMovementActionFuncs_StepDown_Follower,
    [MOVEMENT_ACTION_STEP_UP_FOLLOWER]    = gMovementActionFuncs_StepUp_Follower,
    [MOVEMENT_ACTION_STEP_LEFT_FOLLOWER]  = gMovementActionFuncs_StepLeft_Follower,
    [MOVEMENT_ACTION_STEP_RIGHT_FOLLOWER] = gMovementActionFuncs_StepRight_Follower,

    [MOVEMENT_ACTION_STEP_DOWN_FOLLOWER_SPEED_0]  = gMovementActionFuncs_StepDown_Follower_Speed_0,
    [MOVEMENT_ACTION_STEP_UP_FOLLOWER_SPEED_0]    = gMovementActionFuncs_StepUp_Follower_Speed_0,
    [MOVEMENT_ACTION_STEP_LEFT_FOLLOWER_SPEED_0]  = gMovementActionFuncs_StepLeft_Follower_Speed_0,
    [MOVEMENT_ACTION_STEP_RIGHT_FOLLOWER_SPEED_0] = gMovementActionFuncs_StepRight_Follower_Speed_0,
...
//Idle
u8 (*const gMovementActionFuncs_FaceDown_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Down_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_FaceUp_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Up_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_FaceLeft_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Left_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_FaceRight_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Right_Follower,
    MovementAction_PauseSpriteAnim,
};

//Step 0
u8 (*const gMovementActionFuncs_StepDown_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Down_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepUp_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Up_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepLeft_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Left_Follower,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepRight_Follower[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Right_Follower,
    MovementAction_PauseSpriteAnim,
};

//Speed 1
u8 (*const gMovementActionFuncs_StepDown_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Down_Follower_Speed0,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepUp_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Up_Follower_Speed0,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepLeft_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Left_Follower_Speed0,
    MovementAction_PauseSpriteAnim,
};

u8 (*const gMovementActionFuncs_StepRight_Follower_Speed_0[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_Step_Right_Follower_Speed0,
    MovementAction_PauseSpriteAnim,
};
