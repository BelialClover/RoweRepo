...
const u32 gItemIcon_Booster_Stone[] = INCBIN_U32("graphics/items/icons/tera_orb.4bpp.lz");
const u32 gItemIconPalette_Booster_Stone[] = INCBIN_U32("graphics/items/icon_palettes/tera_orb.gbapal.lz");
