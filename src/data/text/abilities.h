...
static const u8 sPowerSurgeDescription[] = _("Boosts early learned moves if strong enough.");
...
static const u8 sLiquidVoiceDescription[] = _("Boosts the power and accuracy of sound-based moves,\nand changes Normal-type ones to Water-type.");
...
static const u8 sBattleBondDescription[] = _("Changes form at half HP.");
...
static const u8 sFlamingSoulDescription[]  = _("Raises Speed in sunshine.");
...
static const u8 sBuggedOutDescription[]    =  _("Inverses the type matchups only for this Pokémon.");
static const u8 sPsychicMindDescription[]  =  _("Boost Psychic-type moves power and accuracy.");
static const u8 sDracoEnergyDescription[]  =  _("Boost Dragon-type moves power.");
static const u8 sOminousVibeDescription[]  =  _("Boost Ghost-type moves power and speed.");
static const u8 sPoisonateDescription[]    =  _("Normal moves become Poison.");
static const u8 sEvaporateDescription[]    =  _("Becomes immune to Water-type moves.");
static const u8 sPollutionDescription[]    =  _("Poison-type moves become SE agains Bug and Water.");
static const u8 sToxicJawsDescription[]    =  _("Makes biting moves stronger and have a chance\nto poisoning the target.");

static const u8 sLingeringAromaDescription[]    = _("Contact changes the attacker's\nAbility to Lingering Aroma.");
static const u8 sWellBakedBodyDescription[]     = _("Takes no damage from Fire moves.\nSharply raises Defense instead.");
static const u8 sWindPowerDescription[]         = _("Charged by wind moves, boosting\nthe next Electric move's power.");
static const u8 sCommanderDescription[]         = _("Joins Dondozo in battle, aiding\nits ally from inside.");
static const u8 sPurifyingSaltDescription[]     = _("Immune to status and halves\ndamage from Ghost moves.");
static const u8 sMyceliumMightDescription[]     = _("Acts last with status moves but\nignores target's Ability.");
static const u8 sCostarDescription[]            = _("Copies an ally's stat changes\nwhen entering battle.");
static const u8 sToxicDebrisDescription[]       = _("Scatters poison spikes when hit\nby an opponent.");
static const u8 sToxicChainDescription[]        = _("Moves may badly poison targets\nhit by this Pokémon.");
static const u8 sGuardDogDescription[]          = _("Boosts Attack when hit by\nIntimidate.");
static const u8 sBeadsOfRuinDescription[]       = _("Lowers Sp. Def of all Pokémon\nexcept this one.");
static const u8 sSwordOfRuinDescription[]       = _("Lowers Def of all Pokémon except\nthis one.");
static const u8 sTabletsOfRuinDescription[]     = _("Lowers Attack of all Pokémon\nexcept this one.");
static const u8 sVesselOfRuinDescription[]      = _("Lowers Sp. Atk of all Pokémon\nexcept this one.");
static const u8 sGoodAsGoldDescription[]        = _("Immune to status moves from\nother Pokémon.");
static const u8 sThermalExchangeDescription[]   = _("Boosts Attack when hit by\nFire moves.");
static const u8 sProtosynthesisDescription[]    = _("Boosts the highest stat in sun\nor with Booster Energy.");
static const u8 sSupremeOverlordDescription[]   = _("Attack and Sp. Atk rise based\non fainted allies.");
static const u8 sArmorTailDescription[]         = _("Prevents foes from using priority\nmoves.");
static const u8 sOrichalcumPulseDescription[]   = _("Sets harsh sunlight and boosts\nAttack in the sun.");
static const u8 sHadronEngineDescription[]      = _("Sets Electric Terrain and boosts\nSp. Atk on it.");
static const u8 sSupersweetSyrupDescription[]   = _("Lowers foes' evasiveness when\nentering battle.");
static const u8 sTeraShiftDescription[]         = _("Transforms into its Terastal\nForm on entry.");
static const u8 sPoisonPuppeteerDescription[]   = _("Moves poison and confuse foes\nhit by this Pokémon.");
static const u8 sCudChewDescription[]           = _("Eats a Berry again at the end\nof the next turn.");
static const u8 sMindsEyeDescription[]          = _("Ignores evasiveness, accuracy\nloss, and hits Ghost types.");
static const u8 sZeroToHeroDescription[]        = _("Transforms into Hero Form when\nswitching out.");
static const u8 sHospitalityDescription[]       = _("Heals ally's HP slightly when\nentering battle.");
static const u8 sIcyVoiceDescription[]          = _("Boosts the power and accuracy of sound-based moves,\nand changes Normal-type ones to Ice-type.");
#endif
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT_GEN8] =
{
	...
	[ABILITY_POWER_SURGE] = sPowerSurgeDescription,
	[ABILITY_CACOPHONY] = sCacophonyDescription,
	[ABILITY_AIR_CURRENT] = sAirCurrentDescription,
    [ABILITY_SELF_SUFFICIENT] = sAutoHealDescription,
    ...
    [ABILITY_BUGGED_OUT] = sBuggedOutDescription,
    [ABILITY_PSYCHIC_MIND] = sPsychicMindDescription,
    [ABILITY_DRACO_ENERGY] = sDracoEnergyDescription,
    [ABILITY_OMINOUS_VIBE] = sOminousVibeDescription,
    [ABILITY_POISONATE] = sPoisonateDescription,
    [ABILITY_EVAPORATE] = sEvaporateDescription,
    [ABILITY_POLLUTION] = sPollutionDescription,
    [ABILITY_TOXIC_JAWS] = sToxicJawsDescription,
    ...
    [ABILITY_ICY_VOICE]         = sIcyVoiceDescription,
};
