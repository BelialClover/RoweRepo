const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_GIGATON_HAMMER]   = _("Gigaton Hammer"), //Working
    ...
    [MOVE_RAGING_BULL]      = _("Raging Bull"), //Working
    ...
    [MOVE_NEUTRAL_PULSE]    = _("Neutral Pulse"), //Working
    [MOVE_SEASONAL_BEAM]    = _("Seasonal Beam"), //Working
