const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_HITONOME]         = _("Hit-o-nome"),
    [MOVE_TRICKONOME]       = _("Trick-o-nome"),
    [MOVE_AMPONOME]         = _("Amp-o-nome"),
    [MOVE_WEAKONOME]        = _("Weak-o-nome"),
    ...
    [MOVE_BLEAKWIND_STORM] = _("BleakwindStorm"),
    ...
    [MOVE_PSYSHIELD_BASH] = _("PsyshieldBash"),
    [MOVE_SANDSEAR_STORM] = _("SandsearStorm"),
    [MOVE_SHELTER] = _("Shelter"),
    [MOVE_SPRINGTIDE_STORM] = _("SpringtdeStorm"),
    ...
    [MOVE_WILDBOLT_STORM] = _("WildboltStorm"),
    [MOVE_10000000_VOLT_THUNDERBOLT] = _("10MVoltThndrblt"),
    [MOVE_ACID_DOWNPOUR] = _("Acid Downpour"),
    [MOVE_ALL_OUT_PUMMELING] = _("AllOutPummeling"),
    [MOVE_BLACK_HOLE_ECLIPSE] = _("BlackHolEclipse"),
    [MOVE_BLOOM_DOOM] = _("Bloom Doom"),
    [MOVE_BREAKNECK_BLITZ] = _("BreakNeck Blitz"),
    [MOVE_CATASTROPIKA] = _("Catastropika"),
    [MOVE_CLANGOROUS_SOULBLAZE] = _("ClngrsSoulblaze"),
    [MOVE_CONTINENTAL_CRUSH] = _("ContinntlCrush"),
    [MOVE_CORKSCREW_CRASH] = _("CorkscrewCrash"),
    [MOVE_DEVASTATING_DRAKE] = _("DvstatingDrake"),
    [MOVE_EXTREME_EVOBOOST] = _("ExtremeEvoboost"),
    [MOVE_GENESIS_SUPERNOVA] = _("GensisSuperNova"),
    [MOVE_GIGAVOLT_HAVOC] = _("Gigavolt Havoc"),
    [MOVE_GUARDIAN_OF_ALOLA] = _("GuardianOfAlola"),
    [MOVE_HYDRO_VORTEX] = _("Hydro Vortex"),
    [MOVE_INFERNO_OVERDRIVE] = _("InfrnoOverdrive"),
    [MOVE_LETS_SNUGGLE_FOREVER] = _("LetsSnuggleForvr"),
    [MOVE_LIGHT_THAT_BURNS_THE_SKY] = _("BurnsTheSky"),
    [MOVE_MALICIOUS_MOONSAULT] = _("MalicsMoonsault"),
    [MOVE_MENACING_MOONRAZE_MAELSTROM] = _("MnacngMoonraze"),
    [MOVE_NEVER_ENDING_NIGHTMARE] = _("NvrEndNightmare"),
    [MOVE_OCEANIC_OPERETTA] = _("OceanicOperetta"),
    [MOVE_PULVERIZING_PANCAKE] = _("PulvrzngPancake"),
    [MOVE_SAVAGE_SPIN_OUT] = _("Savage Spin Out"),
    [MOVE_SEARING_SUNRAZE_SMASH] = _("SearingSunraze"),
    [MOVE_SHATTERED_PSYCHE] = _("ShatteredPsyche"),
    [MOVE_SINISTER_ARROW_RAID] = _("SnstrArrowRaid"),
    [MOVE_SOUL_STEALING_7_STAR_STRIKE] = _("SoulSteal7Star"),
    [MOVE_SPLINTERED_STORMSHARDS] = _("SplntrdStrmshrd"),
    [MOVE_STOKED_SPARKSURFER] = _("StokdSparksurfr"),
    [MOVE_SUBZERO_SLAMMER] = _("SubzeroSlammer"),
    [MOVE_SUPERSONIC_SKYSTRIKE] = _("SuprSonicSkystk"),
    ...
    [MOVE_G_MAX_BEFUDDLE] = _("G-MaxBefuddle"),
    [MOVE_G_MAX_CANNONADE] = _("G-MaxCannonade"),
    [MOVE_G_MAX_CENTIFERNO] = _("G-MaxCentiferno"),
    [MOVE_G_MAX_CHI_STRIKE] = _("G-MaxChiStrike"),
    [MOVE_G_MAX_CUDDLE] = _("G-Max Cuddle"),
    [MOVE_G_MAX_DEPLETION] = _("G-MaxDepletion"),
    [MOVE_G_MAX_DRUM_SOLO] = _("G-MaxDrumSolo"),
    [MOVE_G_MAX_FINALE] = _("G-Max Finale"),
    [MOVE_G_MAX_FIREBALL] = _("G-MaxFireball"),
    [MOVE_G_MAX_FOAM_BURST] = _("G-MaxFoamBurst"),
    [MOVE_G_MAX_GOLD_RUSH] = _("G-MaxGoldRush"),
    [MOVE_G_MAX_GRAVITAS] = _("G-MaxGravitas"),
    [MOVE_G_MAX_HYDROSNIPE] = _("G-MaxHydrosnipe"),
    [MOVE_G_MAX_MALODOR] = _("G-Max Malodor"),
    [MOVE_G_MAX_MELTDOWN] = _("G-MaxMeltdown"),
    [MOVE_G_MAX_ONE_BLOW] = _("G-Max One Blow"),
    [MOVE_G_MAX_RAPID_FLOW] = _("G-MaxRapidFlow"),
    [MOVE_G_MAX_REPLENISH] = _("G-MaxReplenish"),
    [MOVE_G_MAX_RESONANCE] = _("G-MaxResonance"),
    [MOVE_G_MAX_SANDBLAST] = _("G-MaxSandblast"),
    [MOVE_G_MAX_SMITE] = _("G-Max Smite"),
    [MOVE_G_MAX_SNOOZE] = _("G-Max Snooze"),
    [MOVE_G_MAX_STEELSURGE] = _("G-MaxSteelsurge"),
    [MOVE_G_MAX_STONESURGE] = _("G-MaxStonesurge"),
    [MOVE_G_MAX_STUN_SHOCK] = _("G-MaxStunShock"),
    [MOVE_G_MAX_SWEETNESS] = _("G-MaxSweetness"),
    [MOVE_G_MAX_TARTNESS] = _("G-MaxTartness"),
    [MOVE_G_MAX_TERROR] = _("G-Max Terror"),
    [MOVE_G_MAX_VINE_LASH] = _("G-MaxVineLash"),
    [MOVE_G_MAX_VOLCALITH] = _("G-MaxVolcalith"),
    [MOVE_G_MAX_VOLT_CRASH] = _("G-MaxVoltCrash"),
    [MOVE_G_MAX_WILDFIRE] = _("G-Max Wildfire"),
    [MOVE_G_MAX_WIND_RAGE] = _("G-Max WindRage"),
    [MOVE_PLACEHOLDER]      = _("Placeholder"),
#endif
};
